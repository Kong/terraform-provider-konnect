			...
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeAggregateTestCheckFunc(
						resource.TestCheckResourceAttr("konnect_identity_provider.oidc_provider", "login_path", "testoidc"),
					),
				},
				{
					Config:          providerConfigUs,
			...
			Steps: []resource.TestStep{
				{
					...
					ConfigDirectory: config.TestNameDirectory(),
					Check: resource.ComposeAggregateTestCheckFunc(
						resource.TestCheckResourceAttr("konnect_identity_provider.saml_provider", "login_path", "testsaml"),
					),
				},
				{
					Config:          providerConfigUs,
