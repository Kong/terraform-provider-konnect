			...
			Steps: []resource.TestStep{
				...
				},
				{
					...
					Check: resource.ComposeTestCheckFunc(
						resource.TestCheckResourceAttr("konnect_gateway_plugin_request_callout.my_request_callout", "config.callouts.0.request.url", "http://example.org/uuid"),
						resource.TestCheckNoResourceAttr("konnect_gateway_plugin_request_callout.my_request_callout", "config.upstream"),
					),
				},
			},
		})
