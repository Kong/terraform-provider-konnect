...
page_title: "konnect_portal_list_classic Data Source - terraform-provider-konnect"
subcategory: ""
description: |-
  PortalListClassic DataSource
---

# konnect_portal_list_classic (Data Source)
...
```terraform
data "konnect_portal_list_classic" "my_portallistclassic" {
  filter = {
...
- `custom_client_domain` (Attributes) Filters on the given string field value by exact match inequality. (see [below for nested schema](#nestedatt--filter--custom_client_domain))
- `custom_domain` (Attributes) Filters on the given string field value by exact match inequality. (see [below for nested schema](#nestedatt--filter--custom_domain))
...
- `is_public` (Boolean) Filter by a boolean value (true/false).
...
<a id="nestedatt--filter--custom_client_domain"></a>
### Nested Schema for `filter.custom_client_domain`
...
<a id="nestedatt--filter--custom_domain"></a>
### Nested Schema for `filter.custom_domain`
