...
page_title: "konnect_gateway_plugin_graphql_proxy_cache_advanced Data Source - terraform-provider-konnect"
subcategory: ""
description: |-
  GatewayPluginGraphqlProxyCacheAdvanced DataSource
---

# konnect_gateway_plugin_graphql_proxy_cache_advanced (Data Source)
...
- `strategy` (String) The backing data store in which to hold cached entities. Accepted value is `memory`.
