...
page_title: "konnect_gateway_plugin_forward_proxy Data Source - terraform-provider-konnect"
subcategory: ""
description: |-
  GatewayPluginForwardProxy DataSource
---

# konnect_gateway_plugin_forward_proxy (Data Source)
...
- `proxy_scheme` (String) The proxy scheme to use when connecting. Only `http` is supported.
- `x_headers` (String) Determines how to handle headers when forwarding the request.
