...
page_title: "konnect_gateway_plugin_ai_semantic_prompt_guard Data Source - terraform-provider-konnect"
subcategory: ""
description: |-
  GatewayPluginAiSemanticPromptGuard DataSource
---

# konnect_gateway_plugin_ai_semantic_prompt_guard (Data Source)
...
```terraform
data "konnect_gateway_plugin_ai_semantic_prompt_guard" "my_gatewaypluginaisemanticpromptguard" {
