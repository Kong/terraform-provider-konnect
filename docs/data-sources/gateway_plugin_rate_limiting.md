...
page_title: "konnect_gateway_plugin_rate_limiting Data Source - terraform-provider-konnect"
subcategory: ""
description: |-
  GatewayPluginRateLimiting DataSource
---

# konnect_gateway_plugin_rate_limiting (Data Source)
...
- `limit_by` (String) The entity that is used when aggregating the limits.
