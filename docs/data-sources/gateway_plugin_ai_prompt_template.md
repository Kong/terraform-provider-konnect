...
page_title: "konnect_gateway_plugin_ai_prompt_template Data Source - terraform-provider-konnect"
subcategory: ""
description: |-
  GatewayPluginAiPromptTemplate DataSource
---

# konnect_gateway_plugin_ai_prompt_template (Data Source)
...
- `name` (String) Unique name for the template, can be called with `{template://NAME}`
- `template` (String) Template string for this request, supports mustache-style `{{"{{"}}placeholders{{"}}"}}`
