...
page_title: "konnect_gateway_plugin_header_cert_auth Data Source - terraform-provider-konnect"
subcategory: ""
description: |-
  GatewayPluginHeaderCertAuth DataSource
---

# konnect_gateway_plugin_header_cert_auth (Data Source)
...
- `certificate_header_format` (String) Format of the certificate header. Supported formats: `base64_encoded`, `url_encoded`.
