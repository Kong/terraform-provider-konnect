...
page_title: "konnect_gateway_plugin_kafka_upstream Data Source - terraform-provider-konnect"
subcategory: ""
description: |-
  GatewayPluginKafkaUpstream DataSource
---

# konnect_gateway_plugin_kafka_upstream (Data Source)
...
- `mechanism` (String) The SASL authentication mechanism.  Supported options: `PLAIN`, `SCRAM-SHA-256`, or `SCRAM-SHA-512`.
