...
page_title: "konnect_mesh_http_route Data Source - terraform-provider-konnect"
subcategory: ""
description: |-
  MeshHTTPRoute DataSource
---

# konnect_mesh_http_route (Data Source)
...
```terraform
data "konnect_mesh_http_route" "my_meshhttproute" {
