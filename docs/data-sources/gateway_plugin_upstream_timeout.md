...
page_title: "konnect_gateway_plugin_upstream_timeout Data Source - terraform-provider-konnect"
subcategory: ""
description: |-
  GatewayPluginUpstreamTimeout DataSource
---

# konnect_gateway_plugin_upstream_timeout (Data Source)
...
```terraform
data "konnect_gateway_plugin_upstream_timeout" "my_gatewaypluginupstreamtimeout" {
