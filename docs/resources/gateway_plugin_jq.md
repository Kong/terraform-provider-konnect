...
- `request_if_media_type` (List of String) Default: ["application/json"]
...
- `response_if_media_type` (List of String) Default: ["application/json"]
- `response_if_status_code` (List of Number) Default: [200]
...
```shell
terraform import konnect_gateway_plugin_jq.my_konnect_gateway_plugin_jq '{"control_plane_id": "9524ec7d-36d9-465d-a8c5-83a3c9390458", "id": "3473c251-5b6c-4f45-b1ff-7ede735a366d", "workspace": "team-payments"}'
```
