...
- `auth_type` (String) The type of authentication to be performed. Possible values are: 'openid-connect', 'key-auth', 'v2-strategies'. must be one of ["key-auth", "openid-connect", "v2-strategies"]
