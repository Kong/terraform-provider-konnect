...
resource "konnect_gateway_plugin_jwt_signer" "my_gatewaypluginjwtsigner" {
  config = {
    ...
    access_token_introspection_leeway = 4.53
    ...
    access_token_introspection_timeout       = 2.86
    ...
    access_token_jwks_uri_rotate_period      = 1.93
    ...
    access_token_keyset_rotate_period        = 9.8
    access_token_leeway                      = 5.14
    ...
    access_token_upstream_leeway   = 2.89
    ...
    channel_token_introspection_leeway = 0.49
    ...
    channel_token_introspection_timeout       = 6.38
    ...
    channel_token_jwks_uri_rotate_period      = 5.6
    ...
    channel_token_keyset_rotate_period        = 0.86
    channel_token_leeway                      = 6.13
    ...
    channel_token_upstream_leeway          = 8.87
