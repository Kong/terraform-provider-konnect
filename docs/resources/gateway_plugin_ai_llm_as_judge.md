...
page_title: "konnect_gateway_plugin_ai_llm_as_judge Resource - terraform-provider-konnect"
subcategory: ""
description: |-
  GatewayPluginAiLlmAsJudge Resource
---

# konnect_gateway_plugin_ai_llm_as_judge (Resource)
    ...
    llm = {
      ...
      model = {
        ...
        options = {
          ...
          cache_read_cost  = 9.03
          cache_write_cost = 6.55
...
```shell
terraform import konnect_gateway_plugin_ai_llm_as_judge.my_konnect_gateway_plugin_ai_llm_as_judge '{"control_plane_id": "9524ec7d-36d9-465d-a8c5-83a3c9390458", "id": "3473c251-5b6c-4f45-b1ff-7ede735a366d", "workspace": "team-payments"}'
```
