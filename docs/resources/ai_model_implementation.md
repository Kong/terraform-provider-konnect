...
page_title: "konnect_ai_model_implementation Resource - terraform-provider-konnect"
subcategory: ""
description: |-
  AiModelImplementation Resource
---

# konnect_ai_model_implementation (Resource)
...
```terraform
resource "konnect_ai_model_implementation" "my_aimodelimplementation" {
...
```terraform
import {
  to = konnect_ai_model_implementation.my_konnect_ai_model_implementation
  id = jsonencode({
    ai_model_id = "123e4567-e89b-12d3-a456-426614174000"
...
```shell
terraform import konnect_ai_model_implementation.my_konnect_ai_model_implementation '{"ai_model_id": "123e4567-e89b-12d3-a456-426614174000", "id": "d2e1f0a9-8b7c-6d5e-4f3a-2b1c0d9e8f7a"}'
```
