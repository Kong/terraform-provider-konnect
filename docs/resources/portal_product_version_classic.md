...
page_title: "konnect_portal_product_version_classic Resource - terraform-provider-konnect"
subcategory: ""
description: |-
  PortalProductVersionClassic Resource
---

# konnect_portal_product_version_classic (Resource)
...
```terraform
resource "konnect_portal_product_version_classic" "my_portalproductversionclassic" {
  ...
  portal_id                 = "47cdd6b9-7af4-43a9-bbe0-efa8b03faf7d"
...
```shell
terraform import konnect_portal_product_version_classic.my_konnect_portal_product_version_classic '{"portal_id": "", "product_version_id": "5f9fd312-a987-4628-b4c5-bb4f4fddd5f7"}'
```
