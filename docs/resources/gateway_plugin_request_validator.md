...
```shell
terraform import konnect_gateway_plugin_request_validator.my_konnect_gateway_plugin_request_validator '{"control_plane_id": "9524ec7d-36d9-465d-a8c5-83a3c9390458", "id": "3473c251-5b6c-4f45-b1ff-7ede735a366d", "workspace": "team-payments"}'
```
