...
page_title: "konnect_portal_appearance_classic Resource - terraform-provider-konnect"
subcategory: ""
description: |-
  PortalAppearanceClassic Resource
---

# konnect_portal_appearance_classic (Resource)
...
```terraform
resource "konnect_portal_appearance_classic" "my_portalappearanceclassic" {
  custom_fonts = {
    base     = "Roboto"
    code     = "Roboto"
    headings = "Roboto"
  ...
  portal_id = "3b71ff59-0a0a-4de9-939e-34e95f2d90e2"
  text = {
    catalog = {
...
```shell
terraform import konnect_portal_appearance_classic.my_konnect_portal_appearance_classic ""
```
