...
- `text_source` (String) Select where to pick the 'text' for the Content Guard Services request. possible known values include one of ["concatenate_all_content", "concatenate_user_content", "last_message"]; Default: "concatenate_all_content"
...
```shell
terraform import konnect_gateway_plugin_ai_aws_guardrails.my_konnect_gateway_plugin_ai_aws_guardrails '{"control_plane_id": "9524ec7d-36d9-465d-a8c5-83a3c9390458", "id": "3473c251-5b6c-4f45-b1ff-7ede735a366d", "workspace": "team-payments"}'
```
