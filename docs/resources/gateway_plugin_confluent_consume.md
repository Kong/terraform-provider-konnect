...
- `auto_offset_reset` (String) The offset to start from when there is no initial offset in the consumer group. possible known values include one of ["earliest", "latest"]; Default: "earliest"
...
```shell
terraform import konnect_gateway_plugin_confluent_consume.my_konnect_gateway_plugin_confluent_consume '{"control_plane_id": "9524ec7d-36d9-465d-a8c5-83a3c9390458", "id": "3473c251-5b6c-4f45-b1ff-7ede735a366d", "workspace": "team-payments"}'
```
