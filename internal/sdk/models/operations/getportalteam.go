...
func (g GetPortalTeamRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetPortalTeamRequest) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &g, "", false, []string{"teamId", "portalId"}); err != nil {
		return err
	}
	return nil
}
...
func (g GetPortalTeamResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetPortalTeamResponse) UnmarshalJSON(data []byte) error {
