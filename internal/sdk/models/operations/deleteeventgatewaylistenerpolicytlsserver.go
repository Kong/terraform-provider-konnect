...
func (d DeleteEventGatewayListenerPolicyTLSServerRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteEventGatewayListenerPolicyTLSServerRequest) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &d, "", false, []string{"gatewayId", "eventGatewayListenerId", "policyId"}); err != nil {
		return err
	}
	return nil
}
...
func (d DeleteEventGatewayListenerPolicyTLSServerResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteEventGatewayListenerPolicyTLSServerResponse) UnmarshalJSON(data []byte) error {
