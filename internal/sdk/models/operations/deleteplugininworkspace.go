...
func (d *DeletePluginInWorkspaceRequest) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &d, "", false, []string{"controlPlaneId", "PluginId", "workspace"}); err != nil {
		return err
	}
	return nil
}
...
func (d DeletePluginInWorkspaceResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeletePluginInWorkspaceResponse) UnmarshalJSON(data []byte) error {
