...
func (o *DeleteResponsetransformeradvancedPluginRequest) GetControlPlaneID() string {
	if o == nil {
		return ""
	}
...
func (o *DeleteResponsetransformeradvancedPluginResponse) GetUnauthorizedError() *shared.UnauthorizedError {
	if o == nil {
		return nil
	}
