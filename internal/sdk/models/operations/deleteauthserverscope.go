...
func (d DeleteAuthServerScopeRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteAuthServerScopeRequest) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &d, "", false, []string{"authServerId", "scopeId"}); err != nil {
		return err
	}
	return nil
}
...
func (d DeleteAuthServerScopeResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteAuthServerScopeResponse) UnmarshalJSON(data []byte) error {
