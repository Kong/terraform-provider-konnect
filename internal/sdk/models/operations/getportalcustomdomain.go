...
func (g GetPortalCustomDomainRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetPortalCustomDomainRequest) UnmarshalJSON(data []byte) error {
...
func (g GetPortalCustomDomainResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetPortalCustomDomainResponse) UnmarshalJSON(data []byte) error {
