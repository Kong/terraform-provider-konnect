...
func (o *CreateResponsetransformeradvancedPluginRequest) GetResponseTransformerAdvancedPlugin() shared.ResponseTransformerAdvancedPluginInput {
	if o == nil {
		return shared.ResponseTransformerAdvancedPluginInput{}
	}
