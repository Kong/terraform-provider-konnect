...
func (o *DeleteCorrelationidPluginRequest) GetControlPlaneID() string {
	if o == nil {
		return ""
	}
...
func (o *DeleteCorrelationidPluginResponse) GetUnauthorizedError() *shared.UnauthorizedError {
	if o == nil {
		return nil
	}
