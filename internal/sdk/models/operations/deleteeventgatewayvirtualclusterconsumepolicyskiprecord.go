...
func (d DeleteEventGatewayVirtualClusterConsumePolicySkipRecordRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteEventGatewayVirtualClusterConsumePolicySkipRecordRequest) UnmarshalJSON(data []byte) error {
...
func (d DeleteEventGatewayVirtualClusterConsumePolicySkipRecordResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteEventGatewayVirtualClusterConsumePolicySkipRecordResponse) UnmarshalJSON(data []byte) error {
