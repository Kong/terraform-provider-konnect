...
func (u *UpstreamOauthPluginRedis) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &u, "", false, []string{"cluster_nodes", "sentinel_nodes"}); err != nil {
		return err
	}
	return nil
}
...
func (o *Oauth) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &o, "", false, []string{"scopes", "token_endpoint"}); err != nil {
		return err
	}
	return nil
}
...
func (u *UpstreamOauthPlugin) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &u, "", false, []string{"name", "ordering", "partials", "tags", "config", "consumer", "consumer_group", "route", "service"}); err != nil {
		return err
	}
	return nil
}
