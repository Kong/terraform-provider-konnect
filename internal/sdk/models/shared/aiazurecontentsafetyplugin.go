...
func (o *AiAzureContentSafetyPlugin) GetOrdering() map[string]string {
	if o == nil {
		return nil
	}
	return o.Ordering
...
// AiAzureContentSafetyPluginInput - A Plugin entity represents a plugin configuration that will be executed during the HTTP request/response lifecycle. It is how you can add functionalities to Services that run behind Kong, like Authentication or Rate Limiting for example. You can find more information about how to install and what values each plugin takes by visiting the [Kong Hub](https://docs.konghq.com/hub/). When adding a Plugin Configuration to a Service, every request made by a client to that Service will run said Plugin. If a Plugin needs to be tuned to different values for some specific Consumers, you can do so by creating a separate plugin instance that specifies both the Service and the Consumer, through the `service` and `consumer` fields.
type AiAzureContentSafetyPluginInput struct {
	// Whether the plugin is applied.
	Enabled      *bool             `json:"enabled,omitempty"`
	ID           *string           `json:"id,omitempty"`
	InstanceName *string           `json:"instance_name,omitempty"`
...
func (a *AiAzureContentSafetyPluginInput) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &a, "", false, false); err != nil {
		return err
	}
	return nil
...
func (o *AiAzureContentSafetyPluginInput) GetEnabled() *bool {
	if o == nil {
		return nil
	}
	return o.Enabled
...
func (o *AiAzureContentSafetyPluginInput) GetID() *string {
	if o == nil {
		return nil
	}
	return o.ID
...
func (o *AiAzureContentSafetyPluginInput) GetInstanceName() *string {
	if o == nil {
		return nil
	}
	return o.InstanceName
...
func (o *AiAzureContentSafetyPluginInput) GetName() string {
	return "ai-azure-content-safety"
}

func (o *AiAzureContentSafetyPluginInput) GetOrdering() map[string]string {
	if o == nil {
		return nil
	}
	return o.Ordering
...
func (o *AiAzureContentSafetyPluginInput) GetTags() []string {
	if o == nil {
		return nil
	}
	return o.Tags
...
func (o *AiAzureContentSafetyPluginInput) GetConfig() AiAzureContentSafetyPluginConfig {
	if o == nil {
		return AiAzureContentSafetyPluginConfig{}
	}
	return o.Config
...
func (o *AiAzureContentSafetyPluginInput) GetProtocols() []AiAzureContentSafetyPluginProtocols {
	if o == nil {
		return nil
	}
	return o.Protocols
...
func (o *AiAzureContentSafetyPluginInput) GetRoute() *AiAzureContentSafetyPluginRoute {
	if o == nil {
		return nil
	}
	return o.Route
...
func (o *AiAzureContentSafetyPluginInput) GetService() *AiAzureContentSafetyPluginService {
	if o == nil {
		return nil
	}
	return o.Service
