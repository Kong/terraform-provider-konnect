...
func (o *AiRateLimitingAdvancedPlugin) GetOrdering() map[string]string {
	if o == nil {
		return nil
	}
	return o.Ordering
...
// AiRateLimitingAdvancedPluginInput - A Plugin entity represents a plugin configuration that will be executed during the HTTP request/response lifecycle. It is how you can add functionalities to Services that run behind Kong, like Authentication or Rate Limiting for example. You can find more information about how to install and what values each plugin takes by visiting the [Kong Hub](https://docs.konghq.com/hub/). When adding a Plugin Configuration to a Service, every request made by a client to that Service will run said Plugin. If a Plugin needs to be tuned to different values for some specific Consumers, you can do so by creating a separate plugin instance that specifies both the Service and the Consumer, through the `service` and `consumer` fields.
type AiRateLimitingAdvancedPluginInput struct {
	// Whether the plugin is applied.
	Enabled      *bool             `json:"enabled,omitempty"`
	ID           *string           `json:"id,omitempty"`
	InstanceName *string           `json:"instance_name,omitempty"`
...
func (a *AiRateLimitingAdvancedPluginInput) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &a, "", false, false); err != nil {
		return err
	}
	return nil
...
func (o *AiRateLimitingAdvancedPluginInput) GetEnabled() *bool {
	if o == nil {
		return nil
	}
	return o.Enabled
...
func (o *AiRateLimitingAdvancedPluginInput) GetID() *string {
	if o == nil {
		return nil
	}
	return o.ID
...
func (o *AiRateLimitingAdvancedPluginInput) GetInstanceName() *string {
	if o == nil {
		return nil
	}
	return o.InstanceName
...
func (o *AiRateLimitingAdvancedPluginInput) GetName() string {
	return "ai-rate-limiting-advanced"
}

func (o *AiRateLimitingAdvancedPluginInput) GetOrdering() map[string]string {
	if o == nil {
		return nil
	}
	return o.Ordering
...
func (o *AiRateLimitingAdvancedPluginInput) GetTags() []string {
	if o == nil {
		return nil
	}
	return o.Tags
...
func (o *AiRateLimitingAdvancedPluginInput) GetConfig() AiRateLimitingAdvancedPluginConfig {
	if o == nil {
		return AiRateLimitingAdvancedPluginConfig{}
	}
	return o.Config
...
func (o *AiRateLimitingAdvancedPluginInput) GetConsumer() *AiRateLimitingAdvancedPluginConsumer {
	if o == nil {
		return nil
	}
	return o.Consumer
...
func (o *AiRateLimitingAdvancedPluginInput) GetConsumerGroup() *AiRateLimitingAdvancedPluginConsumerGroup {
	if o == nil {
		return nil
	}
	return o.ConsumerGroup
...
func (o *AiRateLimitingAdvancedPluginInput) GetProtocols() []AiRateLimitingAdvancedPluginProtocols {
	if o == nil {
		return nil
	}
	return o.Protocols
...
func (o *AiRateLimitingAdvancedPluginInput) GetRoute() *AiRateLimitingAdvancedPluginRoute {
	if o == nil {
		return nil
	}
	return o.Route
...
func (o *AiRateLimitingAdvancedPluginInput) GetService() *AiRateLimitingAdvancedPluginService {
	if o == nil {
		return nil
	}
	return o.Service
