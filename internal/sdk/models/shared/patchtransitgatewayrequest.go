...
type PatchTransitGatewayRequest struct {
	PatchAWSResourceEndpointGatewayAWSResourceEndpointGateway *PatchAWSResourceEndpointGatewayAWSResourceEndpointGateway `queryParam:"inline,name=PatchTransitGatewayRequest" union:"member"`
	PatchAWSTransitGatewayAWSTransitGateway                   *PatchAWSTransitGatewayAWSTransitGateway                   `queryParam:"inline,name=PatchTransitGatewayRequest" union:"member"`
