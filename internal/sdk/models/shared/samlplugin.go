...
func (s *SamlPluginConfig) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &s, "", false, []string{"assertion_consumer_path", "idp_sso_url", "issuer", "redis", "session_request_headers", "session_response_headers", "session_secret"}); err != nil {
		return err
	}
	return nil
}
