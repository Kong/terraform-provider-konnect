...
// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *AiSemanticCachePluginAuthMethod) IsExact() bool {
	if e != nil {
		switch *e {
...
// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *AiSemanticCachePluginClientSecretJwtAlg) IsExact() bool {
	if e != nil {
		switch *e {
		case "HS256", "HS512":
			return true
...
// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *AiSemanticCachePluginGrantType) IsExact() bool {
	if e != nil {
		switch *e {
...
type AiSemanticCachePluginOauth struct {
	...
	AuthMethod *AiSemanticCachePluginAuthMethod `default:"client_secret_post" json:"auth_method"`
	// OAuth 2.0 client ID.
	...
	ClientSecretJwtAlg *AiSemanticCachePluginClientSecretJwtAlg `default:"HS512" json:"client_secret_jwt_alg"`
	// OAuth 2.0 grant type used to request access tokens.
	GrantType *AiSemanticCachePluginGrantType `default:"client_credentials" json:"grant_type"`
...
type AiSemanticCachePluginCloudAuthentication struct {
	...
	Oauth *AiSemanticCachePluginOauth `json:"oauth"`
}
...
type AiSemanticCachePluginRedis struct {
	...
	CloudAuthentication *AiSemanticCachePluginCloudAuthentication `json:"cloud_authentication"`
