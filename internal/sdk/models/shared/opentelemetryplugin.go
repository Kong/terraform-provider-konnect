...
func (p *Propagation) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &p, "", false, []string{"clear", "extract", "inject"}); err != nil {
		return err
	}
	return nil
}
...
func (o *OpentelemetryPlugin) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &o, "", false, []string{"name", "ordering", "partials", "tags", "consumer", "route", "service"}); err != nil {
		return err
	}
	return nil
}
