...
// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *GraphqlRateLimitingAdvancedPluginAuthMethod) IsExact() bool {
	if e != nil {
		switch *e {
...
// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *GraphqlRateLimitingAdvancedPluginClientSecretJwtAlg) IsExact() bool {
	if e != nil {
		switch *e {
		case "HS256", "HS512":
			return true
...
// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *GraphqlRateLimitingAdvancedPluginGrantType) IsExact() bool {
	if e != nil {
		switch *e {
...
type GraphqlRateLimitingAdvancedPluginOauth struct {
	...
	AuthMethod *GraphqlRateLimitingAdvancedPluginAuthMethod `default:"client_secret_post" json:"auth_method"`
	// OAuth 2.0 client ID.
	...
	ClientSecretJwtAlg *GraphqlRateLimitingAdvancedPluginClientSecretJwtAlg `default:"HS512" json:"client_secret_jwt_alg"`
	// OAuth 2.0 grant type used to request access tokens.
	GrantType *GraphqlRateLimitingAdvancedPluginGrantType `default:"client_credentials" json:"grant_type"`
...
type GraphqlRateLimitingAdvancedPluginCloudAuthentication struct {
	...
	Oauth *GraphqlRateLimitingAdvancedPluginOauth `json:"oauth"`
}
