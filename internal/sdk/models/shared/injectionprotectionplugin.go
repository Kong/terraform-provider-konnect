...
func (o *InjectionProtectionPlugin) GetOrdering() map[string]string {
	if o == nil {
		return nil
	}
	return o.Ordering
...
func (o *InjectionProtectionPlugin) GetConfig() InjectionProtectionPluginConfig {
	if o == nil {
		return InjectionProtectionPluginConfig{}
	}
	return o.Config
}
...
// InjectionProtectionPluginInput - A Plugin entity represents a plugin configuration that will be executed during the HTTP request/response lifecycle. It is how you can add functionalities to Services that run behind Kong, like Authentication or Rate Limiting for example. You can find more information about how to install and what values each plugin takes by visiting the [Kong Hub](https://docs.konghq.com/hub/). When adding a Plugin Configuration to a Service, every request made by a client to that Service will run said Plugin. If a Plugin needs to be tuned to different values for some specific Consumers, you can do so by creating a separate plugin instance that specifies both the Service and the Consumer, through the `service` and `consumer` fields.
type InjectionProtectionPluginInput struct {
	// Whether the plugin is applied.
	Enabled      *bool             `json:"enabled,omitempty"`
	ID           *string           `json:"id,omitempty"`
	InstanceName *string           `json:"instance_name,omitempty"`
...
func (i *InjectionProtectionPluginInput) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &i, "", false, false); err != nil {
		return err
	}
	return nil
...
func (o *InjectionProtectionPluginInput) GetEnabled() *bool {
	if o == nil {
		return nil
	}
	return o.Enabled
...
func (o *InjectionProtectionPluginInput) GetID() *string {
	if o == nil {
		return nil
	}
	return o.ID
...
func (o *InjectionProtectionPluginInput) GetInstanceName() *string {
	if o == nil {
		return nil
	}
	return o.InstanceName
...
func (o *InjectionProtectionPluginInput) GetName() string {
	return "injection-protection"
}

func (o *InjectionProtectionPluginInput) GetOrdering() map[string]string {
	if o == nil {
		return nil
	}
	return o.Ordering
...
func (o *InjectionProtectionPluginInput) GetTags() []string {
	if o == nil {
		return nil
	}
	return o.Tags
...
func (o *InjectionProtectionPluginInput) GetConfig() InjectionProtectionPluginConfig {
	if o == nil {
		return InjectionProtectionPluginConfig{}
	}
	return o.Config
...
func (o *InjectionProtectionPluginInput) GetProtocols() []InjectionProtectionPluginProtocols {
	if o == nil {
		return nil
	}
	return o.Protocols
...
func (o *InjectionProtectionPluginInput) GetRoute() *InjectionProtectionPluginRoute {
	if o == nil {
		return nil
	}
	return o.Route
...
func (o *InjectionProtectionPluginInput) GetService() *InjectionProtectionPluginService {
	if o == nil {
		return nil
	}
	return o.Service
