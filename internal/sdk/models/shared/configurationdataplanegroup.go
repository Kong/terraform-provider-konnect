...
func (c *ConfigurationDataPlaneGroup) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &c, "", false, []string{"id", "provider", "region", "autoscale", "cloud_gateway_network_id", "state", "private_ip_addresses", "egress_ip_addresses", "created_at", "updated_at"}); err != nil {
		return err
	}
	return nil
}
