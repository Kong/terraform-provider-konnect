...
func (s *ServiceProtectionPluginRedis) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &s, "", false, []string{"cluster_nodes", "sentinel_nodes"}); err != nil {
		return err
	}
	return nil
}
...
func (s *ServiceProtectionPluginConfig) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &s, "", false, []string{"limit", "redis", "window_size"}); err != nil {
		return err
	}
	return nil
}
...
func (s *ServiceProtectionPlugin) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &s, "", false, []string{"name", "ordering", "partials", "tags", "config", "service"}); err != nil {
		return err
	}
	return nil
}
