...
func (a *AiProxyAdvancedPluginConfigMatch) GetType() AiProxyAdvancedPluginType {
	if a == nil {
...
func (a *AiProxyAdvancedPluginMatch) GetType() AiProxyAdvancedPluginConfigType {
	if a == nil {
...
type Acls struct {
	...
	Allow []AiProxyAdvancedPluginAllow `json:"allow"`
...
// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *AiProxyAdvancedPluginAuthMethod) IsExact() bool {
	if e != nil {
		switch *e {
...
// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *AiProxyAdvancedPluginClientSecretJwtAlg) IsExact() bool {
	if e != nil {
		switch *e {
		case "HS256", "HS512":
			return true
...
// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *AiProxyAdvancedPluginGrantType) IsExact() bool {
	if e != nil {
		switch *e {
...
type AiProxyAdvancedPluginOauth struct {
	...
	AuthMethod *AiProxyAdvancedPluginAuthMethod `default:"client_secret_post" json:"auth_method"`
	// OAuth 2.0 client ID.
	...
	ClientSecretJwtAlg *AiProxyAdvancedPluginClientSecretJwtAlg `default:"HS512" json:"client_secret_jwt_alg"`
	// OAuth 2.0 grant type used to request access tokens.
	GrantType *AiProxyAdvancedPluginGrantType `default:"client_credentials" json:"grant_type"`
...
type AiProxyAdvancedPluginCloudAuthentication struct {
	...
	Oauth *AiProxyAdvancedPluginOauth `json:"oauth"`
}
