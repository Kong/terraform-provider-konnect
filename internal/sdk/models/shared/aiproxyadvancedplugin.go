...
func (t *Targets) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &t, "", false, []string{"auth", "logging", "model", "route_type"}); err != nil {
		return err
	}
	return nil
}
...
func (a *AiProxyAdvancedPluginConfig) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &a, "", false, []string{"balancer", "embeddings", "targets", "vectordb"}); err != nil {
		return err
	}
	return nil
}
