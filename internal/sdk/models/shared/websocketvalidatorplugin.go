...
func (w *WebsocketValidatorPluginConfigText) GetType() WebsocketValidatorPluginConfigType {
	if w == nil {
...
func (w *WebsocketValidatorPluginClient) GetText() *WebsocketValidatorPluginConfigText {
	if w == nil {
		return nil
	}
	return w.Text
