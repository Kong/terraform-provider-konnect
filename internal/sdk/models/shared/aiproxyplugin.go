...
func (o *OptionsObj) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &o, "", false, []string{"bedrock", "cohere", "gemini", "huggingface"}); err != nil {
		return err
	}
	return nil
}
...
func (m *Model) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &m, "", false, []string{"options", "provider"}); err != nil {
		return err
	}
	return nil
}
...
func (a *AiProxyPluginConfig) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &a, "", false, []string{"auth", "logging", "model", "route_type"}); err != nil {
		return err
	}
	return nil
}
