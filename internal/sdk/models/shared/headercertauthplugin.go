...
func (o *HeaderCertAuthPlugin) GetOrdering() map[string]string {
	if o == nil {
		return nil
	}
	return o.Ordering
...
// HeaderCertAuthPluginInput - A Plugin entity represents a plugin configuration that will be executed during the HTTP request/response lifecycle. It is how you can add functionalities to Services that run behind Kong, like Authentication or Rate Limiting for example. You can find more information about how to install and what values each plugin takes by visiting the [Kong Hub](https://docs.konghq.com/hub/). When adding a Plugin Configuration to a Service, every request made by a client to that Service will run said Plugin. If a Plugin needs to be tuned to different values for some specific Consumers, you can do so by creating a separate plugin instance that specifies both the Service and the Consumer, through the `service` and `consumer` fields.
type HeaderCertAuthPluginInput struct {
	// Whether the plugin is applied.
	Enabled      *bool             `json:"enabled,omitempty"`
	ID           *string           `json:"id,omitempty"`
	InstanceName *string           `json:"instance_name,omitempty"`
...
func (h *HeaderCertAuthPluginInput) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &h, "", false, false); err != nil {
		return err
	}
	return nil
...
func (o *HeaderCertAuthPluginInput) GetEnabled() *bool {
	if o == nil {
		return nil
	}
	return o.Enabled
...
func (o *HeaderCertAuthPluginInput) GetID() *string {
	if o == nil {
		return nil
	}
	return o.ID
...
func (o *HeaderCertAuthPluginInput) GetInstanceName() *string {
	if o == nil {
		return nil
	}
	return o.InstanceName
...
func (o *HeaderCertAuthPluginInput) GetName() string {
	return "header-cert-auth"
}

func (o *HeaderCertAuthPluginInput) GetOrdering() map[string]string {
	if o == nil {
		return nil
	}
	return o.Ordering
...
func (o *HeaderCertAuthPluginInput) GetTags() []string {
	if o == nil {
		return nil
	}
	return o.Tags
...
func (o *HeaderCertAuthPluginInput) GetConfig() HeaderCertAuthPluginConfig {
	if o == nil {
		return HeaderCertAuthPluginConfig{}
	}
	return o.Config
...
func (o *HeaderCertAuthPluginInput) GetProtocols() []HeaderCertAuthPluginProtocols {
	if o == nil {
		return nil
	}
	return o.Protocols
...
func (o *HeaderCertAuthPluginInput) GetRoute() *HeaderCertAuthPluginRoute {
	if o == nil {
		return nil
	}
	return o.Route
...
func (o *HeaderCertAuthPluginInput) GetService() *HeaderCertAuthPluginService {
	if o == nil {
		return nil
	}
	return o.Service
