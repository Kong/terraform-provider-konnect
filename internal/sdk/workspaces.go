...
func newWorkspaces(rootSDK *Konnect, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Workspaces {
	return &Workspaces{
		rootSDK:          rootSDK,
...
func (s *Workspaces) CreateWorkspace(ctx context.Context, request operations.CreateWorkspaceRequest, opts ...operations.Option) (*operations.CreateWorkspaceResponse, error) {
	...
	case httpRes.StatusCode == 501:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/problem+json`):
			...
			var out shared.NotImplementedError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.NotImplementedError = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
