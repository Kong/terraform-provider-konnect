...
func newCmek(rootSDK *Konnect, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Cmek {
	return &Cmek{
		rootSDK:          rootSDK,
...
func (s *Cmek) GetCmek(ctx context.Context, request operations.GetCmekRequest, opts ...operations.Option) (*operations.GetCmekResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/cmeks/{cmekId}", request, nil)
	if err != nil {
	...
	res := &operations.GetCmekResponse{
...
// PutCmek - Create or replace a CMEK
// Create or replace a customer managed encryption key.
func (s *Cmek) PutCmek(ctx context.Context, request operations.PutCmekRequest, opts ...operations.Option) (*operations.PutCmekResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionAcceptHeaderOverride,
	...
	res := &operations.PutCmekResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *Cmek) DeleteCmek(ctx context.Context, request operations.DeleteCmekRequest, opts ...operations.Option) (*operations.DeleteCmekResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
	...
	res := &operations.DeleteCmekResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
