...
// ResetOrganizationIPAllowList - Reset organization IP allow list
// Disable the IP allow list.
func (s *Konnect) ResetOrganizationIPAllowList(ctx context.Context, request operations.ResetOrganizationIPAllowListRequest, opts ...operations.Option) (*operations.ResetOrganizationIPAllowListResponse, error) {
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "reset-organization-ip-allow-list",
		OAuth2Scopes:     nil,
	...
	res := &operations.ResetOrganizationIPAllowListResponse{
...
// ResetAuthenticationSettings - Reset Auth Settings
// Reset authentication configuration.
func (s *Konnect) ResetAuthenticationSettings(ctx context.Context, request *operations.ResetAuthenticationSettingsRequestBody, opts ...operations.Option) (*operations.ResetAuthenticationSettingsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "reset-authentication-settings",
		OAuth2Scopes:     nil,
		SecuritySource:   s.sdkConfiguration.Security,
	}
	...
	res := &operations.ResetAuthenticationSettingsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
