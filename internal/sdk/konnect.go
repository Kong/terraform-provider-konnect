...
// Generated from OpenAPI doc version 2.0.0 and generator version 2.662.0
...
func New(opts ...SDKOption) *Konnect {
	sdk := &Konnect{
		SDKVersion: "2.12.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 2.12.0 2.662.0 2.0.0 github.com/kong/terraform-provider-konnect/v2/internal/sdk",
