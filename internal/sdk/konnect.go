...
// Generated from OpenAPI doc version 2.0.0 and generator version 2.787.2
...
func New(opts ...SDKOption) *Konnect {
	sdk := &Konnect{
		SDKVersion: "3.4.3",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 3.4.3 2.787.2 2.0.0 github.com/kong/terraform-provider-konnect/v3/internal/sdk",
