...
// Generated from OpenAPI doc version 2.0.0 and generator version 2.723.8
...
func New(opts ...SDKOption) *Konnect {
	sdk := &Konnect{
		SDKVersion: "3.4.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 3.4.0 2.723.8 2.0.0 github.com/kong/terraform-provider-konnect/v3/internal/sdk",
