...
func newIntegrationInstanceAuthCredentials(rootSDK *Konnect, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *IntegrationInstanceAuthCredentials {
...
func (s *IntegrationInstanceAuthCredentials) CreateIntegrationInstanceAuthCredential(ctx context.Context, request operations.CreateIntegrationInstanceAuthCredentialRequest, opts ...operations.Option) (*operations.CreateIntegrationInstanceAuthCredentialResponse, error) {
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.IntegrationInstanceAuthCredential
...
func (s *IntegrationInstanceAuthCredentials) GetIntegrationInstanceAuthCredential(ctx context.Context, request operations.GetIntegrationInstanceAuthCredentialRequest, opts ...operations.Option) (*operations.GetIntegrationInstanceAuthCredentialResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionAcceptHeaderOverride,
...
func (s *IntegrationInstanceAuthCredentials) DeleteIntegrationInstanceAuthCredential(ctx context.Context, request operations.DeleteIntegrationInstanceAuthCredentialRequest, opts ...operations.Option) (*operations.DeleteIntegrationInstanceAuthCredentialResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
