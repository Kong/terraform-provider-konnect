...
func newPortalAppearance(rootSDK *Konnect, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PortalAppearance {
...
// GetPortalAppearanceClassic - Get Appearance Configuration
// Returns the current portal appearance configuration including any custom theme, colors, fonts, and image settings. Portals using the fully-customizable portal client may override or ignore these settings by disregarding them in the code.
func (s *PortalAppearance) GetPortalAppearanceClassic(ctx context.Context, request operations.GetPortalAppearanceClassicRequest, opts ...operations.Option) (*operations.GetPortalAppearanceClassicResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionAcceptHeaderOverride,
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "get-portal-appearance-classic",
		OAuth2Scopes:     []string{},
		SecuritySource:   s.sdkConfiguration.Security,
	}
	...
	res := &operations.GetPortalAppearanceClassicResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
// UpdatePortalAppearanceClassic - Update Appearance Configuration
// Updates the current appearance configuration for this portal including setting pre-defined or custom themes, fonts, colors, and images. Note that portals using the fully-customizable portal client may override or ignore these settings by disregarding them in the code.
func (s *PortalAppearance) UpdatePortalAppearanceClassic(ctx context.Context, request operations.UpdatePortalAppearanceClassicRequest, opts ...operations.Option) (*operations.UpdatePortalAppearanceClassicResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionAcceptHeaderOverride,
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "update-portal-appearance-classic",
		OAuth2Scopes:     []string{},
		SecuritySource:   s.sdkConfiguration.Security,
	}
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "V2PortalAppearance", "json", `request:"mediaType=application/json"`)
	...
	res := &operations.UpdatePortalAppearanceClassicResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
