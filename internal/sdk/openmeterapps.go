...
func newOpenMeterApps(rootSDK *Konnect, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *OpenMeterApps {
...
func (s *OpenMeterApps) ListApps(ctx context.Context, request operations.ListAppsRequest, opts ...operations.Option) (*operations.ListAppsResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.AppPagePaginatedResponse
...
func (s *OpenMeterApps) GetApp(ctx context.Context, request operations.GetAppRequest, opts ...operations.Option) (*operations.GetAppResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionAcceptHeaderOverride,
