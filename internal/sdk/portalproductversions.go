...
func newPortalProductVersions(rootSDK *Konnect, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PortalProductVersions {
...
// GetPortalProductVersionClassic - Get a portal product version
// Get a portal product version
func (s *PortalProductVersions) GetPortalProductVersionClassic(ctx context.Context, request operations.GetPortalProductVersionClassicRequest, opts ...operations.Option) (*operations.GetPortalProductVersionClassicResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionAcceptHeaderOverride,
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "get-portal-product-version-classic",
		OAuth2Scopes:     []string{},
		SecuritySource:   s.sdkConfiguration.Security,
	}
	...
	res := &operations.GetPortalProductVersionClassicResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
// ReplacePortalProductVersionClassic - Replace a portal product version
// Replace a portal product version
func (s *PortalProductVersions) ReplacePortalProductVersionClassic(ctx context.Context, request operations.ReplacePortalProductVersionClassicRequest, opts ...operations.Option) (*operations.ReplacePortalProductVersionClassicResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionAcceptHeaderOverride,
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "replace-portal-product-version-classic",
		OAuth2Scopes:     []string{},
		SecuritySource:   s.sdkConfiguration.Security,
	}
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "V2ReplacePortalProductVersionPayload", "json", `request:"mediaType=application/json"`)
	...
	res := &operations.ReplacePortalProductVersionClassicResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
// DeletePortalProductVersionClassic - Delete a portal product version
// Delete a portal product version
func (s *PortalProductVersions) DeletePortalProductVersionClassic(ctx context.Context, request operations.DeletePortalProductVersionClassicRequest, opts ...operations.Option) (*operations.DeletePortalProductVersionClassicResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "delete-portal-product-version-classic",
		OAuth2Scopes:     []string{},
		SecuritySource:   s.sdkConfiguration.Security,
	}
	...
	res := &operations.DeletePortalProductVersionClassicResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
