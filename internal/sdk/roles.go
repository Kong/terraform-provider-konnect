...
func newRoles(rootSDK *Konnect, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Roles {
	return &Roles{
		rootSDK:          rootSDK,
...
func (s *Roles) GetTeamRole(ctx context.Context, request operations.GetTeamRoleRequest, opts ...operations.Option) (*operations.GetTeamRoleResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
func (s *Roles) UsersAssignRole(ctx context.Context, request operations.UsersAssignRoleRequest, opts ...operations.Option) (*operations.UsersAssignRoleResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
// Returns the assigned role for the specified ID.
func (s *Roles) GetUserRole(ctx context.Context, request operations.GetUserRoleRequest, opts ...operations.Option) (*operations.GetUserRoleResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
func (s *Roles) UsersRemoveRole(ctx context.Context, request operations.UsersRemoveRoleRequest, opts ...operations.Option) (*operations.UsersRemoveRoleResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
