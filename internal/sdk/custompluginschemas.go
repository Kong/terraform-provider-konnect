...
func (s *CustomPluginSchemas) DeletePluginSchemas(ctx context.Context, request operations.DeletePluginSchemasRequest) (*operations.DeletePluginSchemasResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
