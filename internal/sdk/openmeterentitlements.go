...
func newOpenMeterEntitlements(rootSDK *Konnect, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *OpenMeterEntitlements {
...
func (s *OpenMeterEntitlements) ListCustomerEntitlementAccess(ctx context.Context, request operations.ListCustomerEntitlementAccessRequest, opts ...operations.Option) (*operations.ListCustomerEntitlementAccessResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.ListCustomerEntitlementAccessResponseData
