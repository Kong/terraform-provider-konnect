...
func (r *PortalAppearanceClassicResourceModel) RefreshFromSharedV2GetPortalAppearanceResponse(ctx context.Context, resp *shared.V2GetPortalAppearanceResponse) diag.Diagnostics {
...
func (r *PortalAppearanceClassicResourceModel) RefreshFromSharedV2UpdatePortalAppearanceResponse(ctx context.Context, resp *shared.V2UpdatePortalAppearanceResponse) diag.Diagnostics {
	var diags diag.Diagnostics
...
func (r *PortalAppearanceClassicResourceModel) ToOperationsGetPortalAppearanceClassicRequest(ctx context.Context) (*operations.GetPortalAppearanceClassicRequest, diag.Diagnostics) {
	var diags diag.Diagnostics

	var portalID string
	portalID = r.PortalID.ValueString()

	out := operations.GetPortalAppearanceClassicRequest{
		PortalID: portalID,
	}
...
func (r *PortalAppearanceClassicResourceModel) ToOperationsUpdatePortalAppearanceClassicRequest(ctx context.Context) (*operations.UpdatePortalAppearanceClassicRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	out := operations.UpdatePortalAppearanceClassicRequest{
		PortalID:           portalID,
...
func (r *PortalAppearanceClassicResourceModel) ToSharedV2PortalAppearance(ctx context.Context) (*shared.V2PortalAppearance, diag.Diagnostics) {
	var diags diag.Diagnostics
