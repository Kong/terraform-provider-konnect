...
func (r *GatewayPluginTCPLogResourceModel) ToSharedCreateTCPLogPlugin() *shared.CreateTCPLogPlugin {
	...
	var ordering *shared.CreateTCPLogPluginOrdering
	if r.Ordering != nil {
		var after *shared.CreateTCPLogPluginAfter
		if r.Ordering.After != nil {
			var access []string = []string{}
			for _, accessItem := range r.Ordering.After.Access {
				access = append(access, accessItem.ValueString())
			}
			after = &shared.CreateTCPLogPluginAfter{
				Access: access,
			}
		}
		var before *shared.CreateTCPLogPluginBefore
		if r.Ordering.Before != nil {
			var access1 []string = []string{}
			for _, accessItem1 := range r.Ordering.Before.Access {
				access1 = append(access1, accessItem1.ValueString())
			}
			before = &shared.CreateTCPLogPluginBefore{
				Access: access1,
			}
		}
		ordering = &shared.CreateTCPLogPluginOrdering{
			After:  after,
			Before: before,
		}
	}
