...
var _ datasource.DataSource = &GatewayPluginTLSMetadataHeadersDataSource{}
var _ datasource.DataSourceWithConfigure = &GatewayPluginTLSMetadataHeadersDataSource{}

func NewGatewayPluginTLSMetadataHeadersDataSource() datasource.DataSource {
	return &GatewayPluginTLSMetadataHeadersDataSource{}
}

// GatewayPluginTLSMetadataHeadersDataSource is the data source implementation.
type GatewayPluginTLSMetadataHeadersDataSource struct {
	client *sdk.Konnect
}
...
func (r *GatewayPluginTLSMetadataHeadersDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_gateway_plugin_tls_metadata_headers"
}

// Schema defines the schema for the data source.
func (r *GatewayPluginTLSMetadataHeadersDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "GatewayPluginTLSMetadataHeaders DataSource",
...
func (r *GatewayPluginTLSMetadataHeadersDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *GatewayPluginTLSMetadataHeadersDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *GatewayPluginTLSMetadataHeadersDataSourceModel
