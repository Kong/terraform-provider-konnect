...
var _ datasource.DataSource = &GatewayPluginAzureFunctionsDataSource{}
var _ datasource.DataSourceWithConfigure = &GatewayPluginAzureFunctionsDataSource{}

func NewGatewayPluginAzureFunctionsDataSource() datasource.DataSource {
	return &GatewayPluginAzureFunctionsDataSource{}
}

// GatewayPluginAzureFunctionsDataSource is the data source implementation.
type GatewayPluginAzureFunctionsDataSource struct {
	client *sdk.Konnect
}
...
func (r *GatewayPluginAzureFunctionsDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_gateway_plugin_azure_functions"
}

// Schema defines the schema for the data source.
func (r *GatewayPluginAzureFunctionsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "GatewayPluginAzureFunctions DataSource",
...
func (r *GatewayPluginAzureFunctionsDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *GatewayPluginAzureFunctionsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *GatewayPluginAzureFunctionsDataSourceModel
