...
func (r *GatewayPluginFileLogResourceModel) ToSharedCreateFileLogPlugin() *shared.CreateFileLogPlugin {
	...
	var ordering *shared.CreateFileLogPluginOrdering
	if r.Ordering != nil {
		var after *shared.CreateFileLogPluginAfter
		if r.Ordering.After != nil {
			var access []string = []string{}
			for _, accessItem := range r.Ordering.After.Access {
				access = append(access, accessItem.ValueString())
			}
			after = &shared.CreateFileLogPluginAfter{
				Access: access,
			}
		}
		var before *shared.CreateFileLogPluginBefore
		if r.Ordering.Before != nil {
			var access1 []string = []string{}
			for _, accessItem1 := range r.Ordering.Before.Access {
				access1 = append(access1, accessItem1.ValueString())
			}
			before = &shared.CreateFileLogPluginBefore{
				Access: access1,
			}
		}
		ordering = &shared.CreateFileLogPluginOrdering{
			After:  after,
			Before: before,
		}
	}
