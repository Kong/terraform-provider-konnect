...
func (r *GatewayPluginAiRagInjectorDataSourceModel) ToOperationsGetAiraginjectorPluginRequest(ctx context.Context) (*operations.GetAiraginjectorPluginRequest, diag.Diagnostics) {
...
func (r *GatewayPluginAiRagInjectorDataSourceModel) RefreshFromSharedAiRagInjectorPlugin(ctx context.Context, resp *shared.AiRagInjectorPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
