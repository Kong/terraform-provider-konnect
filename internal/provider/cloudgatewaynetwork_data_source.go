...
type CloudGatewayNetworkDataSourceModel struct {
	...
	Filter                        *tfTypes.NetworksFilterParameters `queryParam:"style=deepObject,explode=true,name=filter" tfsdk:"filter"`
...
func (r *CloudGatewayNetworkDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	resp.Diagnostics.Append(data.RefreshFromSharedListNetworksResponse(ctx, res.ListNetworksResponse)...)
