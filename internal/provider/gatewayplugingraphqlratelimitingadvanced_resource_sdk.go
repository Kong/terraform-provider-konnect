...
func (r *GatewayPluginGraphqlRateLimitingAdvancedResourceModel) ToSharedCreateGraphqlRateLimitingAdvancedPlugin() *shared.CreateGraphqlRateLimitingAdvancedPlugin {
	var config *shared.CreateGraphqlRateLimitingAdvancedPluginConfig
	if r.Config != nil {
		costStrategy := new(shared.CreateGraphqlRateLimitingAdvancedPluginCostStrategy)
		if !r.Config.CostStrategy.IsUnknown() && !r.Config.CostStrategy.IsNull() {
			*costStrategy = shared.CreateGraphqlRateLimitingAdvancedPluginCostStrategy(r.Config.CostStrategy.ValueString())
		} else {
			costStrategy = nil
		}
		...
		identifier := new(shared.CreateGraphqlRateLimitingAdvancedPluginIdentifier)
		if !r.Config.Identifier.IsUnknown() && !r.Config.Identifier.IsNull() {
			*identifier = shared.CreateGraphqlRateLimitingAdvancedPluginIdentifier(r.Config.Identifier.ValueString())
		} else {
			identifier = nil
		}
		...
		windowType := new(shared.CreateGraphqlRateLimitingAdvancedPluginWindowType)
		if !r.Config.WindowType.IsUnknown() && !r.Config.WindowType.IsNull() {
			*windowType = shared.CreateGraphqlRateLimitingAdvancedPluginWindowType(r.Config.WindowType.ValueString())
		} else {
			windowType = nil
		}
	...
	var ordering *shared.CreateGraphqlRateLimitingAdvancedPluginOrdering
	if r.Ordering != nil {
		var after *shared.CreateGraphqlRateLimitingAdvancedPluginAfter
		if r.Ordering.After != nil {
			var access []string = []string{}
			for _, accessItem := range r.Ordering.After.Access {
				access = append(access, accessItem.ValueString())
			}
			after = &shared.CreateGraphqlRateLimitingAdvancedPluginAfter{
				Access: access,
			}
		}
		var before *shared.CreateGraphqlRateLimitingAdvancedPluginBefore
		if r.Ordering.Before != nil {
			var access1 []string = []string{}
			for _, accessItem1 := range r.Ordering.Before.Access {
				access1 = append(access1, accessItem1.ValueString())
			}
			before = &shared.CreateGraphqlRateLimitingAdvancedPluginBefore{
				Access: access1,
			}
		}
		ordering = &shared.CreateGraphqlRateLimitingAdvancedPluginOrdering{
			After:  after,
			Before: before,
		}
	}
