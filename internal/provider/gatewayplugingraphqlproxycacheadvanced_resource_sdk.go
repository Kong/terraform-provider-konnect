...
func (r *GatewayPluginGraphqlProxyCacheAdvancedResourceModel) ToSharedCreateGraphqlProxyCacheAdvancedPlugin() *shared.CreateGraphqlProxyCacheAdvancedPlugin {
	...
	if r.Config != nil {
		...
		var memory *shared.CreateGraphqlProxyCacheAdvancedPluginMemory
		if r.Config.Memory != nil {
			...
			memory = &shared.CreateGraphqlProxyCacheAdvancedPluginMemory{
				DictionaryName: dictionaryName,
			}
		}
		var redis *shared.CreateGraphqlProxyCacheAdvancedPluginRedis
		if r.Config.Redis != nil {
			...
			var clusterNodes []shared.CreateGraphqlProxyCacheAdvancedPluginClusterNodes = []shared.CreateGraphqlProxyCacheAdvancedPluginClusterNodes{}
			for _, clusterNodesItem := range r.Config.Redis.ClusterNodes {
				...
				clusterNodes = append(clusterNodes, shared.CreateGraphqlProxyCacheAdvancedPluginClusterNodes{
					IP:   ip,
					Port: port,
				})
			}
			...
			var sentinelNodes []shared.CreateGraphqlProxyCacheAdvancedPluginSentinelNodes = []shared.CreateGraphqlProxyCacheAdvancedPluginSentinelNodes{}
			for _, sentinelNodesItem := range r.Config.Redis.SentinelNodes {
				...
				sentinelNodes = append(sentinelNodes, shared.CreateGraphqlProxyCacheAdvancedPluginSentinelNodes{
					Host: host1,
					Port: port2,
				})
			}
			...
			sentinelRole := new(shared.CreateGraphqlProxyCacheAdvancedPluginSentinelRole)
			if !r.Config.Redis.SentinelRole.IsUnknown() && !r.Config.Redis.SentinelRole.IsNull() {
				*sentinelRole = shared.CreateGraphqlProxyCacheAdvancedPluginSentinelRole(r.Config.Redis.SentinelRole.ValueString())
			} else {
				sentinelRole = nil
			}
			...
			redis = &shared.CreateGraphqlProxyCacheAdvancedPluginRedis{
		...
		strategy := new(shared.CreateGraphqlProxyCacheAdvancedPluginStrategy)
		if !r.Config.Strategy.IsUnknown() && !r.Config.Strategy.IsNull() {
			*strategy = shared.CreateGraphqlProxyCacheAdvancedPluginStrategy(r.Config.Strategy.ValueString())
		} else {
			strategy = nil
		}
	...
	var ordering *shared.CreateGraphqlProxyCacheAdvancedPluginOrdering
	if r.Ordering != nil {
		var after *shared.CreateGraphqlProxyCacheAdvancedPluginAfter
		if r.Ordering.After != nil {
			var access []string = []string{}
			for _, accessItem := range r.Ordering.After.Access {
				access = append(access, accessItem.ValueString())
			}
			after = &shared.CreateGraphqlProxyCacheAdvancedPluginAfter{
				Access: access,
			}
		}
		var before *shared.CreateGraphqlProxyCacheAdvancedPluginBefore
		if r.Ordering.Before != nil {
			var access1 []string = []string{}
			for _, accessItem1 := range r.Ordering.Before.Access {
				access1 = append(access1, accessItem1.ValueString())
			}
			before = &shared.CreateGraphqlProxyCacheAdvancedPluginBefore{
				Access: access1,
			}
		}
		ordering = &shared.CreateGraphqlProxyCacheAdvancedPluginOrdering{
			After:  after,
			Before: before,
		}
	}
