...
func (r *GatewayPluginProxyCacheAdvancedResourceModel) ToSharedCreateProxyCacheAdvancedPlugin() *shared.CreateProxyCacheAdvancedPlugin {
	...
	var ordering *shared.CreateProxyCacheAdvancedPluginOrdering
	if r.Ordering != nil {
		var after *shared.CreateProxyCacheAdvancedPluginAfter
		if r.Ordering.After != nil {
			var access []string = []string{}
			for _, accessItem := range r.Ordering.After.Access {
				access = append(access, accessItem.ValueString())
			}
			after = &shared.CreateProxyCacheAdvancedPluginAfter{
				Access: access,
			}
		}
		var before *shared.CreateProxyCacheAdvancedPluginBefore
		if r.Ordering.Before != nil {
			var access1 []string = []string{}
			for _, accessItem1 := range r.Ordering.Before.Access {
				access1 = append(access1, accessItem1.ValueString())
			}
			before = &shared.CreateProxyCacheAdvancedPluginBefore{
				Access: access1,
			}
		}
		ordering = &shared.CreateProxyCacheAdvancedPluginOrdering{
			After:  after,
			Before: before,
		}
	}
