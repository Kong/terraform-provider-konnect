...
func (r *GatewayPluginGrpcWebResourceModel) ToSharedCreateGrpcWebPlugin() *shared.CreateGrpcWebPlugin {
	...
	var ordering *shared.CreateGrpcWebPluginOrdering
	if r.Ordering != nil {
		var after *shared.CreateGrpcWebPluginAfter
		if r.Ordering.After != nil {
			var access []string = []string{}
			for _, accessItem := range r.Ordering.After.Access {
				access = append(access, accessItem.ValueString())
			}
			after = &shared.CreateGrpcWebPluginAfter{
				Access: access,
			}
		}
		var before *shared.CreateGrpcWebPluginBefore
		if r.Ordering.Before != nil {
			var access1 []string = []string{}
			for _, accessItem1 := range r.Ordering.Before.Access {
				access1 = append(access1, accessItem1.ValueString())
			}
			before = &shared.CreateGrpcWebPluginBefore{
				Access: access1,
			}
		}
		ordering = &shared.CreateGrpcWebPluginOrdering{
			After:  after,
			Before: before,
		}
	}
