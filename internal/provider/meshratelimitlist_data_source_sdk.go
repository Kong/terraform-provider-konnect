		...
		for itemsCount, itemsItem := range resp.Items {
			...
			if itemsItem.Spec.TargetRef == nil {
				...
				if len(itemsItem.Spec.TargetRef.Labels) > 0 {
					...
					for key3, value5 := range itemsItem.Spec.TargetRef.Labels {
						items1.Spec.TargetRef.Labels[key3] = types.StringValue(value5)
					}
				}
				...
				if len(itemsItem.Spec.TargetRef.Tags) > 0 {
					...
					for key4, value6 := range itemsItem.Spec.TargetRef.Tags {
						items1.Spec.TargetRef.Tags[key4] = types.StringValue(value6)
					}
				}
			}
