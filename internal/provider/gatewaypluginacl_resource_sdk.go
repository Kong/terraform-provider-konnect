...
func (r *GatewayPluginACLResourceModel) ToSharedACLPlugin(ctx context.Context) (*shared.ACLPlugin, diag.Diagnostics) {
	...
	if r.Config != nil {
		...
		var allowWhen []string
		if r.Config.AllowWhen != nil {
