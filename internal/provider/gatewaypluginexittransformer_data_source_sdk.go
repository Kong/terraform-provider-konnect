...
func (r *GatewayPluginExitTransformerDataSourceModel) ToOperationsGetExittransformerPluginRequest(ctx context.Context) (*operations.GetExittransformerPluginRequest, diag.Diagnostics) {
...
func (r *GatewayPluginExitTransformerDataSourceModel) RefreshFromSharedExitTransformerPlugin(ctx context.Context, resp *shared.ExitTransformerPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
