...
func (r *GatewayPluginRedirectDataSourceModel) ToOperationsGetRedirectPluginRequest(ctx context.Context) (*operations.GetRedirectPluginRequest, diag.Diagnostics) {
...
func (r *GatewayPluginRedirectDataSourceModel) RefreshFromSharedRedirectPlugin(ctx context.Context, resp *shared.RedirectPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
