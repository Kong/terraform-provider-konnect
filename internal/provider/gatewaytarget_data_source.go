...
var _ datasource.DataSource = &GatewayTargetDataSource{}
var _ datasource.DataSourceWithConfigure = &GatewayTargetDataSource{}

func NewGatewayTargetDataSource() datasource.DataSource {
	return &GatewayTargetDataSource{}
}

// GatewayTargetDataSource is the data source implementation.
type GatewayTargetDataSource struct {
	client *sdk.Konnect
}
...
func (r *GatewayTargetDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_gateway_target"
}

// Schema defines the schema for the data source.
func (r *GatewayTargetDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "GatewayTarget DataSource",
...
func (r *GatewayTargetDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *GatewayTargetDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *GatewayTargetDataSourceModel
