...
func (r *GatewayPluginRequestTransformerResourceModel) ToSharedCreateRequestTransformerPlugin() *shared.CreateRequestTransformerPlugin {
	...
	var ordering *shared.CreateRequestTransformerPluginOrdering
	if r.Ordering != nil {
		var after *shared.CreateRequestTransformerPluginAfter
		if r.Ordering.After != nil {
			var access []string = []string{}
			for _, accessItem := range r.Ordering.After.Access {
				access = append(access, accessItem.ValueString())
			}
			after = &shared.CreateRequestTransformerPluginAfter{
				Access: access,
			}
		}
		var before *shared.CreateRequestTransformerPluginBefore
		if r.Ordering.Before != nil {
			var access1 []string = []string{}
			for _, accessItem1 := range r.Ordering.Before.Access {
				access1 = append(access1, accessItem1.ValueString())
			}
			before = &shared.CreateRequestTransformerPluginBefore{
				Access: access1,
			}
		}
		ordering = &shared.CreateRequestTransformerPluginOrdering{
			After:  after,
			Before: before,
		}
	}
