	...
	if resp != nil {
		...
		if resp.Config.Rules == nil {
			...
			if resp.Config.Rules.AllowResponses != nil {
				...
				r.Config.Rules.AllowResponses = nil
			}
			if resp.Config.Rules.DenyResponses != nil {
				...
				r.Config.Rules.DenyResponses = nil
			}
...
func (r *GatewayPluginAiSemanticResponseGuardResourceModel) ToSharedAiSemanticResponseGuardPlugin(ctx context.Context) (*shared.AiSemanticResponseGuardPlugin, diag.Diagnostics) {
	...
	var embeddings *shared.AiSemanticResponseGuardPluginEmbeddings
	...
	var vectordb *shared.AiSemanticResponseGuardPluginVectordb
