...
func (r *GatewayPluginTLSMetadataHeadersResourceModel) ToSharedCreateTLSMetadataHeadersPlugin() *shared.CreateTLSMetadataHeadersPlugin {
	...
	var ordering *shared.CreateTLSMetadataHeadersPluginOrdering
	if r.Ordering != nil {
		var after *shared.CreateTLSMetadataHeadersPluginAfter
		if r.Ordering.After != nil {
			var access []string = []string{}
			for _, accessItem := range r.Ordering.After.Access {
				access = append(access, accessItem.ValueString())
			}
			after = &shared.CreateTLSMetadataHeadersPluginAfter{
				Access: access,
			}
		}
		var before *shared.CreateTLSMetadataHeadersPluginBefore
		if r.Ordering.Before != nil {
			var access1 []string = []string{}
			for _, accessItem1 := range r.Ordering.Before.Access {
				access1 = append(access1, accessItem1.ValueString())
			}
			before = &shared.CreateTLSMetadataHeadersPluginBefore{
				Access: access1,
			}
		}
		ordering = &shared.CreateTLSMetadataHeadersPluginOrdering{
			After:  after,
			Before: before,
		}
	}
