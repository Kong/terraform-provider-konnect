...
func (r *GatewayPluginAiPromptGuardDataSourceModel) ToOperationsGetAipromptguardPluginRequest(ctx context.Context) (*operations.GetAipromptguardPluginRequest, diag.Diagnostics) {
...
func (r *GatewayPluginAiPromptGuardDataSourceModel) RefreshFromSharedAiPromptGuardPlugin(ctx context.Context, resp *shared.AiPromptGuardPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
