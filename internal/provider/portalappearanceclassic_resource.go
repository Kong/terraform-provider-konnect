...
var _ resource.Resource = &PortalAppearanceClassicResource{}
var _ resource.ResourceWithImportState = &PortalAppearanceClassicResource{}

func NewPortalAppearanceClassicResource() resource.Resource {
	return &PortalAppearanceClassicResource{}
}

// PortalAppearanceClassicResource defines the resource implementation.
type PortalAppearanceClassicResource struct {
	// Provider configured SDK client.
	client *sdk.Konnect
}

// PortalAppearanceClassicResourceModel describes the resource data model.
type PortalAppearanceClassicResourceModel struct {
...
func (r *PortalAppearanceClassicResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_portal_appearance_classic"
}

func (r *PortalAppearanceClassicResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PortalAppearanceClassic Resource",
...
func (r *PortalAppearanceClassicResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PortalAppearanceClassicResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PortalAppearanceClassicResourceModel
	...
	request, requestDiags := data.ToOperationsUpdatePortalAppearanceClassicRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.PortalAppearance.UpdatePortalAppearanceClassic(ctx, *request)
	if err != nil {
...
func (r *PortalAppearanceClassicResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PortalAppearanceClassicResourceModel
	...
	request, requestDiags := data.ToOperationsGetPortalAppearanceClassicRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.PortalAppearance.GetPortalAppearanceClassic(ctx, *request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *PortalAppearanceClassicResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PortalAppearanceClassicResourceModel
	var plan types.Object
...
func (r *PortalAppearanceClassicResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PortalAppearanceClassicResourceModel
	var item types.Object
...
func (r *PortalAppearanceClassicResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
