...
var _ datasource.DataSource = &GatewayPluginCanaryDataSource{}
var _ datasource.DataSourceWithConfigure = &GatewayPluginCanaryDataSource{}

func NewGatewayPluginCanaryDataSource() datasource.DataSource {
	return &GatewayPluginCanaryDataSource{}
}

// GatewayPluginCanaryDataSource is the data source implementation.
type GatewayPluginCanaryDataSource struct {
	client *sdk.Konnect
}
...
func (r *GatewayPluginCanaryDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_gateway_plugin_canary"
}

// Schema defines the schema for the data source.
func (r *GatewayPluginCanaryDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "GatewayPluginCanary DataSource",
...
func (r *GatewayPluginCanaryDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *GatewayPluginCanaryDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *GatewayPluginCanaryDataSourceModel
