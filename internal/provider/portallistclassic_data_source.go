...
var _ datasource.DataSource = &PortalListClassicDataSource{}
var _ datasource.DataSourceWithConfigure = &PortalListClassicDataSource{}

func NewPortalListClassicDataSource() datasource.DataSource {
	return &PortalListClassicDataSource{}
}

// PortalListClassicDataSource is the data source implementation.
type PortalListClassicDataSource struct {
	// Provider configured SDK client.
	client *sdk.Konnect
}

// PortalListClassicDataSourceModel describes the data model.
type PortalListClassicDataSourceModel struct {
...
func (r *PortalListClassicDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_portal_list_classic"
}

// Schema defines the schema for the data source.
func (r *PortalListClassicDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PortalListClassic DataSource",
		...
		Attributes: map[string]schema.Attribute{
			...
			"filter": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"custom_client_domain": schema.SingleNestedAttribute{
						Optional: true,
						Attributes: map[string]schema.Attribute{
...
func (r *PortalListClassicDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PortalListClassicDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PortalListClassicDataSourceModel
