...
func (r *GatewayPluginAiPromptTemplateDataSourceModel) ToOperationsGetAiprompttemplatePluginRequest(ctx context.Context) (*operations.GetAiprompttemplatePluginRequest, diag.Diagnostics) {
