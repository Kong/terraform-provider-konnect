...
var _ datasource.DataSource = &GatewayPluginXMLThreatProtectionDataSource{}
var _ datasource.DataSourceWithConfigure = &GatewayPluginXMLThreatProtectionDataSource{}

func NewGatewayPluginXMLThreatProtectionDataSource() datasource.DataSource {
	return &GatewayPluginXMLThreatProtectionDataSource{}
}

// GatewayPluginXMLThreatProtectionDataSource is the data source implementation.
type GatewayPluginXMLThreatProtectionDataSource struct {
	client *sdk.Konnect
}
...
func (r *GatewayPluginXMLThreatProtectionDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_gateway_plugin_xml_threat_protection"
}

// Schema defines the schema for the data source.
func (r *GatewayPluginXMLThreatProtectionDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "GatewayPluginXMLThreatProtection DataSource",
...
func (r *GatewayPluginXMLThreatProtectionDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *GatewayPluginXMLThreatProtectionDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *GatewayPluginXMLThreatProtectionDataSourceModel
