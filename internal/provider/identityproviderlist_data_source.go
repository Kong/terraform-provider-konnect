...
var _ datasource.DataSource = &IdentityProviderListDataSource{}
var _ datasource.DataSourceWithConfigure = &IdentityProviderListDataSource{}

func NewIdentityProviderListDataSource() datasource.DataSource {
	return &IdentityProviderListDataSource{}
}

// IdentityProviderListDataSource is the data source implementation.
type IdentityProviderListDataSource struct {
	// Provider configured SDK client.
	client *sdk.Konnect
}

// IdentityProviderListDataSourceModel describes the data model.
type IdentityProviderListDataSourceModel struct {
	Data   []tfTypes.IdentityProvider `tfsdk:"data"`
	Filter *tfTypes.Filter            `queryParam:"style=deepObject,explode=true,name=filter" tfsdk:"filter"`
}

// Metadata returns the data source type name.
func (r *IdentityProviderListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_identity_provider_list"
}

// Schema defines the schema for the data source.
func (r *IdentityProviderListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "IdentityProviderList DataSource",
...
func (r *IdentityProviderListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *IdentityProviderListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *IdentityProviderListDataSourceModel
	...
	resp.Diagnostics.Append(data.RefreshFromSharedIdentityProvider(ctx, res.IdentityProviders)...)
