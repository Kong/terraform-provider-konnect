...
var _ datasource.DataSource = &GatewayPluginKonnectApplicationAuthDataSource{}
var _ datasource.DataSourceWithConfigure = &GatewayPluginKonnectApplicationAuthDataSource{}

func NewGatewayPluginKonnectApplicationAuthDataSource() datasource.DataSource {
	return &GatewayPluginKonnectApplicationAuthDataSource{}
}

// GatewayPluginKonnectApplicationAuthDataSource is the data source implementation.
type GatewayPluginKonnectApplicationAuthDataSource struct {
	client *sdk.Konnect
}
...
func (r *GatewayPluginKonnectApplicationAuthDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_gateway_plugin_konnect_application_auth"
}

// Schema defines the schema for the data source.
func (r *GatewayPluginKonnectApplicationAuthDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "GatewayPluginKonnectApplicationAuth DataSource",
...
func (r *GatewayPluginKonnectApplicationAuthDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *GatewayPluginKonnectApplicationAuthDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *GatewayPluginKonnectApplicationAuthDataSourceModel
