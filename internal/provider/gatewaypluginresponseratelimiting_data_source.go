...
var _ datasource.DataSource = &GatewayPluginResponseRatelimitingDataSource{}
var _ datasource.DataSourceWithConfigure = &GatewayPluginResponseRatelimitingDataSource{}

func NewGatewayPluginResponseRatelimitingDataSource() datasource.DataSource {
	return &GatewayPluginResponseRatelimitingDataSource{}
}

// GatewayPluginResponseRatelimitingDataSource is the data source implementation.
type GatewayPluginResponseRatelimitingDataSource struct {
	client *sdk.Konnect
}
...
func (r *GatewayPluginResponseRatelimitingDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_gateway_plugin_response_ratelimiting"
}

// Schema defines the schema for the data source.
func (r *GatewayPluginResponseRatelimitingDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "GatewayPluginResponseRatelimiting DataSource",
...
func (r *GatewayPluginResponseRatelimitingDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *GatewayPluginResponseRatelimitingDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *GatewayPluginResponseRatelimitingDataSourceModel
