...
func (r *GatewayPluginSessionResourceModel) ToSharedCreateSessionPlugin() *shared.CreateSessionPlugin {
	...
	if r.Config != nil {
		...
		cookieSameSite := new(shared.CreateSessionPluginCookieSameSite)
		if !r.Config.CookieSameSite.IsUnknown() && !r.Config.CookieSameSite.IsNull() {
			*cookieSameSite = shared.CreateSessionPluginCookieSameSite(r.Config.CookieSameSite.ValueString())
		} else {
			cookieSameSite = nil
		}
		...
		var requestHeaders []shared.CreateSessionPluginRequestHeaders = []shared.CreateSessionPluginRequestHeaders{}
		for _, requestHeadersItem := range r.Config.RequestHeaders {
			requestHeaders = append(requestHeaders, shared.CreateSessionPluginRequestHeaders(requestHeadersItem.ValueString()))
		}
	...
	var ordering *shared.CreateSessionPluginOrdering
	if r.Ordering != nil {
		var after *shared.CreateSessionPluginAfter
		if r.Ordering.After != nil {
			var access []string = []string{}
			for _, accessItem := range r.Ordering.After.Access {
				access = append(access, accessItem.ValueString())
			}
			after = &shared.CreateSessionPluginAfter{
				Access: access,
			}
		}
		var before *shared.CreateSessionPluginBefore
		if r.Ordering.Before != nil {
			var access1 []string = []string{}
			for _, accessItem1 := range r.Ordering.Before.Access {
				access1 = append(access1, accessItem1.ValueString())
			}
			before = &shared.CreateSessionPluginBefore{
				Access: access1,
			}
		}
		ordering = &shared.CreateSessionPluginOrdering{
			After:  after,
			Before: before,
		}
	}
