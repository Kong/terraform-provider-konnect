...
func (r *GatewayPluginGraphqlRateLimitingAdvancedDataSourceModel) ToOperationsGetGraphqlratelimitingadvancedPluginRequest(ctx context.Context) (*operations.GetGraphqlratelimitingadvancedPluginRequest, diag.Diagnostics) {
...
func (r *GatewayPluginGraphqlRateLimitingAdvancedDataSourceModel) RefreshFromSharedGraphqlRateLimitingAdvancedPlugin(ctx context.Context, resp *shared.GraphqlRateLimitingAdvancedPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
