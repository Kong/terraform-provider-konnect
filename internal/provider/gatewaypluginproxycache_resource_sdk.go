...
func (r *GatewayPluginProxyCacheResourceModel) ToSharedCreateProxyCachePlugin() *shared.CreateProxyCachePlugin {
	...
	var ordering *shared.CreateProxyCachePluginOrdering
	if r.Ordering != nil {
		var after *shared.CreateProxyCachePluginAfter
		if r.Ordering.After != nil {
			var access []string = []string{}
			for _, accessItem := range r.Ordering.After.Access {
				access = append(access, accessItem.ValueString())
			}
			after = &shared.CreateProxyCachePluginAfter{
				Access: access,
			}
		}
		var before *shared.CreateProxyCachePluginBefore
		if r.Ordering.Before != nil {
			var access1 []string = []string{}
			for _, accessItem1 := range r.Ordering.Before.Access {
				access1 = append(access1, accessItem1.ValueString())
			}
			before = &shared.CreateProxyCachePluginBefore{
				Access: access1,
			}
		}
		ordering = &shared.CreateProxyCachePluginOrdering{
			After:  after,
			Before: before,
		}
	}
