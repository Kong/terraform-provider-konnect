...
func (r *GatewayPluginServiceProtectionDataSourceModel) ToOperationsGetServiceprotectionPluginRequest(ctx context.Context) (*operations.GetServiceprotectionPluginRequest, diag.Diagnostics) {
...
func (r *GatewayPluginServiceProtectionDataSourceModel) RefreshFromSharedServiceProtectionPlugin(ctx context.Context, resp *shared.ServiceProtectionPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
