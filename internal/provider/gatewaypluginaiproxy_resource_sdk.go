	...
	if r.Config != nil {
		...
		if r.Config.Model != nil {
			...
			if r.Config.Model.Options != nil {
				...
				var bedrock *shared.CreateAiProxyPluginBedrock
				if r.Config.Model.Options.Bedrock != nil {
					...
					bedrock = &shared.CreateAiProxyPluginBedrock{
						AwsRegion: awsRegion,
					}
				}
				var gemini *shared.CreateAiProxyPluginGemini
				if r.Config.Model.Options.Gemini != nil {
					...
					gemini = &shared.CreateAiProxyPluginGemini{
