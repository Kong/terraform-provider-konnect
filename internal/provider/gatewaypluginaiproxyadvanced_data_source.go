...
var _ datasource.DataSource = &GatewayPluginAiProxyAdvancedDataSource{}
var _ datasource.DataSourceWithConfigure = &GatewayPluginAiProxyAdvancedDataSource{}

func NewGatewayPluginAiProxyAdvancedDataSource() datasource.DataSource {
	return &GatewayPluginAiProxyAdvancedDataSource{}
}

// GatewayPluginAiProxyAdvancedDataSource is the data source implementation.
type GatewayPluginAiProxyAdvancedDataSource struct {
	client *sdk.Konnect
}
...
func (r *GatewayPluginAiProxyAdvancedDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_gateway_plugin_ai_proxy_advanced"
}

// Schema defines the schema for the data source.
func (r *GatewayPluginAiProxyAdvancedDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "GatewayPluginAiProxyAdvanced DataSource",
...
func (r *GatewayPluginAiProxyAdvancedDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *GatewayPluginAiProxyAdvancedDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *GatewayPluginAiProxyAdvancedDataSourceModel
