...
var _ datasource.DataSource = &GatewayPluginAiRagInjectorDataSource{}
var _ datasource.DataSourceWithConfigure = &GatewayPluginAiRagInjectorDataSource{}

func NewGatewayPluginAiRagInjectorDataSource() datasource.DataSource {
	return &GatewayPluginAiRagInjectorDataSource{}
}

// GatewayPluginAiRagInjectorDataSource is the data source implementation.
type GatewayPluginAiRagInjectorDataSource struct {
	client *sdk.Konnect
}

// GatewayPluginAiRagInjectorDataSourceModel describes the data model.
type GatewayPluginAiRagInjectorDataSourceModel struct {
...
func (r *GatewayPluginAiRagInjectorDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_gateway_plugin_ai_rag_injector"
}

// Schema defines the schema for the data source.
func (r *GatewayPluginAiRagInjectorDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "GatewayPluginAiRagInjector DataSource",
...
func (r *GatewayPluginAiRagInjectorDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *GatewayPluginAiRagInjectorDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *GatewayPluginAiRagInjectorDataSourceModel
