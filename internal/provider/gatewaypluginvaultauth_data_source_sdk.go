...
func (r *GatewayPluginVaultAuthDataSourceModel) ToOperationsGetVaultauthPluginRequest(ctx context.Context) (*operations.GetVaultauthPluginRequest, diag.Diagnostics) {
