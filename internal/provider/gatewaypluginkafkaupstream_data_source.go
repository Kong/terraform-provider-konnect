...
var _ datasource.DataSource = &GatewayPluginKafkaUpstreamDataSource{}
var _ datasource.DataSourceWithConfigure = &GatewayPluginKafkaUpstreamDataSource{}

func NewGatewayPluginKafkaUpstreamDataSource() datasource.DataSource {
	return &GatewayPluginKafkaUpstreamDataSource{}
}

// GatewayPluginKafkaUpstreamDataSource is the data source implementation.
type GatewayPluginKafkaUpstreamDataSource struct {
	client *sdk.Konnect
}
...
func (r *GatewayPluginKafkaUpstreamDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_gateway_plugin_kafka_upstream"
}

// Schema defines the schema for the data source.
func (r *GatewayPluginKafkaUpstreamDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "GatewayPluginKafkaUpstream DataSource",
...
func (r *GatewayPluginKafkaUpstreamDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *GatewayPluginKafkaUpstreamDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *GatewayPluginKafkaUpstreamDataSourceModel
