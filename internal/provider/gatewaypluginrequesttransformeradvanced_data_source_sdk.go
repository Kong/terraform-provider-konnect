...
func (r *GatewayPluginRequestTransformerAdvancedDataSourceModel) ToOperationsGetRequesttransformeradvancedPluginRequest(ctx context.Context) (*operations.GetRequesttransformeradvancedPluginRequest, diag.Diagnostics) {
...
func (r *GatewayPluginRequestTransformerAdvancedDataSourceModel) RefreshFromSharedRequestTransformerAdvancedPlugin(ctx context.Context, resp *shared.RequestTransformerAdvancedPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
