...
func (r *GatewayPluginProxyCacheDataSourceModel) ToOperationsGetProxycachePluginRequest(ctx context.Context) (*operations.GetProxycachePluginRequest, diag.Diagnostics) {
...
func (r *GatewayPluginProxyCacheDataSourceModel) RefreshFromSharedProxyCachePlugin(ctx context.Context, resp *shared.ProxyCachePlugin) diag.Diagnostics {
	var diags diag.Diagnostics
