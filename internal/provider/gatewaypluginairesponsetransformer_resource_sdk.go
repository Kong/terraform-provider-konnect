...
func (r *GatewayPluginAiResponseTransformerResourceModel) ToSharedCreateAiResponseTransformerPlugin() *shared.CreateAiResponseTransformerPlugin {
	...
	var ordering *shared.CreateAiResponseTransformerPluginOrdering
	if r.Ordering != nil {
		var after *shared.CreateAiResponseTransformerPluginAfter
		if r.Ordering.After != nil {
			var access []string = []string{}
			for _, accessItem := range r.Ordering.After.Access {
				access = append(access, accessItem.ValueString())
			}
			after = &shared.CreateAiResponseTransformerPluginAfter{
				Access: access,
			}
		}
		var before *shared.CreateAiResponseTransformerPluginBefore
		if r.Ordering.Before != nil {
			var access1 []string = []string{}
			for _, accessItem1 := range r.Ordering.Before.Access {
				access1 = append(access1, accessItem1.ValueString())
			}
			before = &shared.CreateAiResponseTransformerPluginBefore{
				Access: access1,
			}
		}
		ordering = &shared.CreateAiResponseTransformerPluginOrdering{
			After:  after,
			Before: before,
		}
	}
