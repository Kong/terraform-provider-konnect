...
func (r *GatewayPluginGrpcGatewayResourceModel) ToSharedCreateGrpcGatewayPlugin() *shared.CreateGrpcGatewayPlugin {
	...
	var ordering *shared.CreateGrpcGatewayPluginOrdering
	if r.Ordering != nil {
		var after *shared.CreateGrpcGatewayPluginAfter
		if r.Ordering.After != nil {
			var access []string = []string{}
			for _, accessItem := range r.Ordering.After.Access {
				access = append(access, accessItem.ValueString())
			}
			after = &shared.CreateGrpcGatewayPluginAfter{
				Access: access,
			}
		}
		var before *shared.CreateGrpcGatewayPluginBefore
		if r.Ordering.Before != nil {
			var access1 []string = []string{}
			for _, accessItem1 := range r.Ordering.Before.Access {
				access1 = append(access1, accessItem1.ValueString())
			}
			before = &shared.CreateGrpcGatewayPluginBefore{
				Access: access1,
			}
		}
		ordering = &shared.CreateGrpcGatewayPluginOrdering{
			After:  after,
			Before: before,
		}
	}
