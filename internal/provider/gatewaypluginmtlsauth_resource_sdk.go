...
func (r *GatewayPluginMtlsAuthResourceModel) ToSharedCreateMtlsAuthPlugin() *shared.CreateMtlsAuthPlugin {
	...
	if r.Config != nil {
		...
		authenticatedGroupBy := new(shared.CreateMtlsAuthPluginAuthenticatedGroupBy)
		if !r.Config.AuthenticatedGroupBy.IsUnknown() && !r.Config.AuthenticatedGroupBy.IsNull() {
			*authenticatedGroupBy = shared.CreateMtlsAuthPluginAuthenticatedGroupBy(r.Config.AuthenticatedGroupBy.ValueString())
		} else {
		...
		revocationCheckMode := new(shared.CreateMtlsAuthPluginRevocationCheckMode)
		if !r.Config.RevocationCheckMode.IsUnknown() && !r.Config.RevocationCheckMode.IsNull() {
			*revocationCheckMode = shared.CreateMtlsAuthPluginRevocationCheckMode(r.Config.RevocationCheckMode.ValueString())
		} else {
	...
	var ordering *shared.CreateMtlsAuthPluginOrdering
	if r.Ordering != nil {
		var after *shared.CreateMtlsAuthPluginAfter
		if r.Ordering.After != nil {
			var access []string = []string{}
			for _, accessItem := range r.Ordering.After.Access {
				access = append(access, accessItem.ValueString())
			}
			after = &shared.CreateMtlsAuthPluginAfter{
				Access: access,
			}
		}
		var before *shared.CreateMtlsAuthPluginBefore
		if r.Ordering.Before != nil {
			var access1 []string = []string{}
			for _, accessItem1 := range r.Ordering.Before.Access {
				access1 = append(access1, accessItem1.ValueString())
			}
			before = &shared.CreateMtlsAuthPluginBefore{
				Access: access1,
			}
		}
		ordering = &shared.CreateMtlsAuthPluginOrdering{
			After:  after,
			Before: before,
		}
	}
