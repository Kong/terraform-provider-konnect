...
var _ datasource.DataSource = &GatewayPluginDatadogDataSource{}
var _ datasource.DataSourceWithConfigure = &GatewayPluginDatadogDataSource{}

func NewGatewayPluginDatadogDataSource() datasource.DataSource {
	return &GatewayPluginDatadogDataSource{}
}

// GatewayPluginDatadogDataSource is the data source implementation.
type GatewayPluginDatadogDataSource struct {
	client *sdk.Konnect
}
...
func (r *GatewayPluginDatadogDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_gateway_plugin_datadog"
}

// Schema defines the schema for the data source.
func (r *GatewayPluginDatadogDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "GatewayPluginDatadog DataSource",
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"name": schema.StringAttribute{
									Computed:    true,
									Description: `Datadog metric’s name. must be one of ["kong_latency", "latency", "request_count", "request_size", "response_size", "upstream_latency"]`,
								},
								...
								"stat_type": schema.StringAttribute{
									Computed:    true,
									Description: `Determines what sort of event the metric represents. must be one of ["counter", "gauge", "histogram", "meter", "set", "timer", "distribution"]`,
								},
...
func (r *GatewayPluginDatadogDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *GatewayPluginDatadogDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *GatewayPluginDatadogDataSourceModel
