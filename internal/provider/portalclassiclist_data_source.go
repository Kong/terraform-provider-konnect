...
var _ datasource.DataSource = &PortalClassicListDataSource{}
var _ datasource.DataSourceWithConfigure = &PortalClassicListDataSource{}

func NewPortalClassicListDataSource() datasource.DataSource {
	return &PortalClassicListDataSource{}
}

// PortalClassicListDataSource is the data source implementation.
type PortalClassicListDataSource struct {
...
func (r *PortalClassicListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_portal_classic_list"
}

// Schema defines the schema for the data source.
func (r *PortalClassicListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PortalClassicList DataSource",
...
func (r *PortalClassicListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PortalClassicListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PortalClassicListDataSourceModel
