...
func (r *GatewayPluginRateLimitingAdvancedDataSourceModel) ToOperationsGetRatelimitingadvancedPluginRequest(ctx context.Context) (*operations.GetRatelimitingadvancedPluginRequest, diag.Diagnostics) {
...
func (r *GatewayPluginRateLimitingAdvancedDataSourceModel) RefreshFromSharedRateLimitingAdvancedPlugin(ctx context.Context, resp *shared.RateLimitingAdvancedPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
