				...
				if resp.Config.RateLimiting.Redis == nil {
					...
					if resp.Config.RateLimiting.Redis.CloudAuthentication == nil {
						...
						if resp.Config.RateLimiting.Redis.CloudAuthentication.Oauth == nil {
							...
							if resp.Config.RateLimiting.Redis.CloudAuthentication.Oauth.TokenHeaders != nil {
							...
							if resp.Config.RateLimiting.Redis.CloudAuthentication.Oauth.TokenPostArgs != nil {
			...
			if r.Config.RateLimiting.Redis != nil {
				...
				if r.Config.RateLimiting.Redis.CloudAuthentication != nil {
					...
					if r.Config.RateLimiting.Redis.CloudAuthentication.Oauth != nil {
						...
						if r.Config.RateLimiting.Redis.CloudAuthentication.Oauth.TokenHeaders != nil {
						...
						if r.Config.RateLimiting.Redis.CloudAuthentication.Oauth.TokenPostArgs != nil {
