...
func (r *GatewayPluginGraphqlProxyCacheAdvancedDataSourceModel) ToOperationsGetGraphqlproxycacheadvancedPluginRequest(ctx context.Context) (*operations.GetGraphqlproxycacheadvancedPluginRequest, diag.Diagnostics) {
...
func (r *GatewayPluginGraphqlProxyCacheAdvancedDataSourceModel) RefreshFromSharedGraphqlProxyCacheAdvancedPlugin(ctx context.Context, resp *shared.GraphqlProxyCacheAdvancedPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
