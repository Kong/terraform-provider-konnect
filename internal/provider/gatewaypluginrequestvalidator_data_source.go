...
var _ datasource.DataSource = &GatewayPluginRequestValidatorDataSource{}
var _ datasource.DataSourceWithConfigure = &GatewayPluginRequestValidatorDataSource{}

func NewGatewayPluginRequestValidatorDataSource() datasource.DataSource {
	return &GatewayPluginRequestValidatorDataSource{}
}

// GatewayPluginRequestValidatorDataSource is the data source implementation.
type GatewayPluginRequestValidatorDataSource struct {
	client *sdk.Konnect
}
...
func (r *GatewayPluginRequestValidatorDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_gateway_plugin_request_validator"
}

// Schema defines the schema for the data source.
func (r *GatewayPluginRequestValidatorDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "GatewayPluginRequestValidator DataSource",
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"in": schema.StringAttribute{
									Computed:    true,
									Description: `The location of the parameter. must be one of ["query", "header", "path"]`,
								},
...
func (r *GatewayPluginRequestValidatorDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *GatewayPluginRequestValidatorDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *GatewayPluginRequestValidatorDataSourceModel
