...
func (r *GatewayPluginLdapAuthDataSourceModel) ToOperationsGetLdapauthPluginRequest(ctx context.Context) (*operations.GetLdapauthPluginRequest, diag.Diagnostics) {
...
func (r *GatewayPluginLdapAuthDataSourceModel) RefreshFromSharedLdapAuthPlugin(ctx context.Context, resp *shared.LdapAuthPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
