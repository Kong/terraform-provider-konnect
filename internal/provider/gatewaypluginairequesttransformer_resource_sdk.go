...
func (r *GatewayPluginAiRequestTransformerResourceModel) ToSharedCreateAiRequestTransformerPlugin() *shared.CreateAiRequestTransformerPlugin {
	...
	if r.Config != nil {
		...
		var llm *shared.CreateAiRequestTransformerPluginLlm
		if r.Config.Llm != nil {
			...
			llm = &shared.CreateAiRequestTransformerPluginLlm{
				Auth:      auth,
				Logging:   logging,
				Model:     model,
				RouteType: routeType,
	...
	var ordering *shared.CreateAiRequestTransformerPluginOrdering
	if r.Ordering != nil {
		var after *shared.CreateAiRequestTransformerPluginAfter
		if r.Ordering.After != nil {
			var access []string = []string{}
			for _, accessItem := range r.Ordering.After.Access {
				access = append(access, accessItem.ValueString())
			}
			after = &shared.CreateAiRequestTransformerPluginAfter{
				Access: access,
			}
		}
		var before *shared.CreateAiRequestTransformerPluginBefore
		if r.Ordering.Before != nil {
			var access1 []string = []string{}
			for _, accessItem1 := range r.Ordering.Before.Access {
				access1 = append(access1, accessItem1.ValueString())
			}
			before = &shared.CreateAiRequestTransformerPluginBefore{
				Access: access1,
			}
		}
		ordering = &shared.CreateAiRequestTransformerPluginOrdering{
			After:  after,
			Before: before,
		}
	}
...
func (r *GatewayPluginAiRequestTransformerResourceModel) RefreshFromSharedAiRequestTransformerPlugin(resp *shared.AiRequestTransformerPlugin) {
	if resp != nil {
		if resp.Config == nil {
			r.Config = nil
		} else {
			...
			if resp.Config.Llm == nil {
				...
				r.Config.Llm = &tfTypes.CreateAiRequestTransformerPluginLlm{}
				if resp.Config.Llm.Auth == nil {
					r.Config.Llm.Auth = nil
				} else {
					r.Config.Llm.Auth = &tfTypes.CreateAiProxyPluginAuth{}
				...
				if resp.Config.Llm.Logging == nil {
					...
					r.Config.Llm.Logging = &tfTypes.CreateAiProxyPluginLogging{}
				...
				if resp.Config.Llm.Model == nil {
					...
					r.Config.Llm.Model = &tfTypes.CreateAiProxyPluginModel{}
					...
					if resp.Config.Llm.Model.Options == nil {
						...
						r.Config.Llm.Model.Options = &tfTypes.CreateAiProxyPluginOptions{}
						...
						if resp.Config.Llm.Model.Options.Bedrock == nil {
							...
							r.Config.Llm.Model.Options.Bedrock = &tfTypes.CreateAiProxyPluginBedrock{}
						...
						if resp.Config.Llm.Model.Options.Gemini == nil {
							...
							r.Config.Llm.Model.Options.Gemini = &tfTypes.CreateAiProxyPluginGemini{}
