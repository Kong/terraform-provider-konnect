...
func (r *GatewayPluginSolaceLogResourceModel) RefreshFromSharedSolaceLogPlugin(ctx context.Context, resp *shared.SolaceLogPlugin) diag.Diagnostics {
...
func (r *GatewayPluginSolaceLogResourceModel) ToSharedSolaceLogPlugin(ctx context.Context) (*shared.SolaceLogPlugin, diag.Diagnostics) {
	var diags diag.Diagnostics
