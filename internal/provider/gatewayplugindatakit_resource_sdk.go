				...
				if resp.Config.Resources.Cache.Redis == nil {
					...
					if resp.Config.Resources.Cache.Redis.CloudAuthentication == nil {
						...
						if resp.Config.Resources.Cache.Redis.CloudAuthentication.Oauth == nil {
							...
							if resp.Config.Resources.Cache.Redis.CloudAuthentication.Oauth.TokenHeaders != nil {
							...
							if resp.Config.Resources.Cache.Redis.CloudAuthentication.Oauth.TokenPostArgs != nil {
...
func (r *GatewayPluginDatakitResourceModel) ToSharedDatakitPlugin(ctx context.Context) (*shared.DatakitPlugin, diag.Diagnostics) {
	...
	for nodesItem := range r.Config.Nodes {
		...
		if r.Config.Nodes[nodesItem].Static != nil {
			...
			var outputs6 map[string]string
			...
			if r.Config.Resources.Cache.Redis != nil {
				...
				if r.Config.Resources.Cache.Redis.CloudAuthentication != nil {
					...
					if r.Config.Resources.Cache.Redis.CloudAuthentication.Oauth != nil {
						...
						if r.Config.Resources.Cache.Redis.CloudAuthentication.Oauth.TokenHeaders != nil {
						...
						if r.Config.Resources.Cache.Redis.CloudAuthentication.Oauth.TokenPostArgs != nil {
