...
func (r *GatewayPluginAiProxyAdvancedResourceModel) ToSharedAiProxyAdvancedPluginInput() *shared.AiProxyAdvancedPluginInput {
	enabled := new(bool)
	...
	out := shared.AiProxyAdvancedPluginInput{
		Enabled:       enabled,
		ID:            id,
...
func (r *GatewayPluginAiProxyAdvancedResourceModel) RefreshFromSharedAiProxyAdvancedPlugin(resp *shared.AiProxyAdvancedPlugin) {
	if resp != nil {
