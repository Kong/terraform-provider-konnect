...
func (r *CatalogMCPImplementationResourceModel) RefreshFromSharedCatalogMCPImplementation(ctx context.Context, resp *shared.CatalogMCPImplementation) diag.Diagnostics {
	...
	if resp != nil {
		if resp.AIGatewayMCPCatalog1 != nil {
			r.AIGatewayMCPCatalog = &tfTypes.AIGatewayMCPCatalog{}
			r.AIGatewayMCPCatalog.CreatedAt = types.StringValue(typeconvert.TimeToString(resp.AIGatewayMCPCatalog1.CreatedAt))
			r.CreatedAt = r.AIGatewayMCPCatalog.CreatedAt
			r.AIGatewayMCPCatalog.ID = types.StringValue(resp.AIGatewayMCPCatalog1.ID)
			r.ID = r.AIGatewayMCPCatalog.ID
			r.AIGatewayMCPCatalog.Implementation = &tfTypes.CatalogMCPGatewayImplementationBlock{}
			r.AIGatewayMCPCatalog.Implementation.Config = &tfTypes.CatalogMCPGatewayImplementationConfig{}
			r.AIGatewayMCPCatalog.Implementation.Config.AiGatewayID = types.StringValue(resp.AIGatewayMCPCatalog1.Implementation.Config.AiGatewayID)
			r.AIGatewayMCPCatalog.Implementation.Config.AiGatewayMcpServerID = types.StringValue(resp.AIGatewayMCPCatalog1.Implementation.Config.AiGatewayMcpServerID)
			r.AIGatewayMCPCatalog.UpdatedAt = types.StringValue(typeconvert.TimeToString(resp.AIGatewayMCPCatalog1.UpdatedAt))
			r.UpdatedAt = r.AIGatewayMCPCatalog.UpdatedAt
		}
	}
