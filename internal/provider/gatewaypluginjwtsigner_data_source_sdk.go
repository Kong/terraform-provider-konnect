...
func (r *GatewayPluginJwtSignerDataSourceModel) ToOperationsGetJwtsignerPluginRequest(ctx context.Context) (*operations.GetJwtsignerPluginRequest, diag.Diagnostics) {
...
func (r *GatewayPluginJwtSignerDataSourceModel) RefreshFromSharedJwtSignerPlugin(ctx context.Context, resp *shared.JwtSignerPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
