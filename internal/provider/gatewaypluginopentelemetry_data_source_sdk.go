...
func (r *GatewayPluginOpentelemetryDataSourceModel) ToOperationsGetOpentelemetryPluginRequest(ctx context.Context) (*operations.GetOpentelemetryPluginRequest, diag.Diagnostics) {
