...
func (r *MeshTimeoutResourceModel) ToSharedMeshTimeoutItem() *shared.MeshTimeoutItem {
	...
	for _, fromItem := range r.Spec.From {
		...
		kind := new(shared.MeshTimeoutItemSpecKind)
	...
	if r.Spec.TargetRef != nil {
		kind1 := new(shared.MeshTimeoutItemKind)
	...
	for _, toItem := range r.Spec.To {
		...
		kind2 := new(shared.MeshTimeoutItemSpecToKind)
