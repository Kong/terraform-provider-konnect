...
var _ datasource.DataSource = &GatewayPluginConfluentDataSource{}
var _ datasource.DataSourceWithConfigure = &GatewayPluginConfluentDataSource{}

func NewGatewayPluginConfluentDataSource() datasource.DataSource {
	return &GatewayPluginConfluentDataSource{}
}

// GatewayPluginConfluentDataSource is the data source implementation.
type GatewayPluginConfluentDataSource struct {
	client *sdk.Konnect
}
...
func (r *GatewayPluginConfluentDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_gateway_plugin_confluent"
}

// Schema defines the schema for the data source.
func (r *GatewayPluginConfluentDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "GatewayPluginConfluent DataSource",
...
func (r *GatewayPluginConfluentDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *GatewayPluginConfluentDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *GatewayPluginConfluentDataSourceModel
