...
func (r *MeshRateLimitResourceModel) ToSharedMeshRateLimitItem() *shared.MeshRateLimitItem {
	...
	for _, fromItem := range r.Spec.From {
		...
		kind := new(shared.MeshRateLimitItemSpecKind)
	...
	if r.Spec.TargetRef != nil {
		kind1 := new(shared.MeshRateLimitItemKind)
		...
		if !r.Spec.TargetRef.Name.IsUnknown() && !r.Spec.TargetRef.Name.IsNull() {
			*name4 = r.Spec.TargetRef.Name.ValueString()
		} else {
			name4 = nil
		}
	...
	for _, toItem := range r.Spec.To {
			...
			if toItem.Default.Local != nil {
				...
				if toItem.Default.Local.HTTP != nil {
					...
					if !toItem.Default.Local.HTTP.Disabled.IsUnknown() && !toItem.Default.Local.HTTP.Disabled.IsNull() {
						*disabled2 = toItem.Default.Local.HTTP.Disabled.ValueBool()
					} else {
						disabled2 = nil
					}
					...
					if toItem.Default.Local.HTTP.OnRateLimit != nil {
						...
						if toItem.Default.Local.HTTP.OnRateLimit.Headers != nil {
							...
							for _, addItem1 := range toItem.Default.Local.HTTP.OnRateLimit.Headers.Add {
								var name5 string
								name5 = addItem1.Name.ValueString()
							...
							for _, setItem1 := range toItem.Default.Local.HTTP.OnRateLimit.Headers.Set {
								var name6 string
								name6 = setItem1.Name.ValueString()
						...
						if !toItem.Default.Local.HTTP.OnRateLimit.Status.IsUnknown() && !toItem.Default.Local.HTTP.OnRateLimit.Status.IsNull() {
							*status1 = int(toItem.Default.Local.HTTP.OnRateLimit.Status.ValueInt64())
						} else {
							status1 = nil
						}
					...
					if toItem.Default.Local.HTTP.RequestRate != nil {
						...
						interval2 = toItem.Default.Local.HTTP.RequestRate.Interval.ValueString()

						var num2 int
						num2 = int(toItem.Default.Local.HTTP.RequestRate.Num.ValueInt64())
				...
				if toItem.Default.Local.TCP != nil {
					...
					if toItem.Default.Local.TCP.ConnectionRate != nil {
						...
						interval3 = toItem.Default.Local.TCP.ConnectionRate.Interval.ValueString()

						var num3 int
						num3 = int(toItem.Default.Local.TCP.ConnectionRate.Num.ValueInt64())
					...
					if !toItem.Default.Local.TCP.Disabled.IsUnknown() && !toItem.Default.Local.TCP.Disabled.IsNull() {
						*disabled3 = toItem.Default.Local.TCP.Disabled.ValueBool()
					} else {
						disabled3 = nil
					}
		...
		kind2 := new(shared.MeshRateLimitItemSpecToKind)
		...
		if !toItem.TargetRef.Name.IsUnknown() && !toItem.TargetRef.Name.IsNull() {
			*name7 = toItem.TargetRef.Name.ValueString()
		} else {
			name7 = nil
		}
