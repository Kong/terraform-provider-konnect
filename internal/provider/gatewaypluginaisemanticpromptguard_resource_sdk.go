...
func (r *GatewayPluginAiSemanticPromptGuardResourceModel) ToSharedAiSemanticPromptGuardPluginInput() *shared.AiSemanticPromptGuardPluginInput {
	enabled := new(bool)
	...
	out := shared.AiSemanticPromptGuardPluginInput{
		Enabled:       enabled,
		ID:            id,
