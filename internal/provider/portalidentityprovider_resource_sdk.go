...
func (r *PortalIdentityProviderResourceModel) RefreshFromSharedIdentityProvider(ctx context.Context, resp *shared.IdentityProvider) diag.Diagnostics {
...
func (r *PortalIdentityProviderResourceModel) ToOperationsCreatePortalIdentityProviderRequest(ctx context.Context) (*operations.CreatePortalIdentityProviderRequest, diag.Diagnostics) {
	...
	createIdentityProvider, createIdentityProviderDiags := r.ToSharedCreateIdentityProvider(ctx)
	diags.Append(createIdentityProviderDiags...)
...
func (r *PortalIdentityProviderResourceModel) ToSharedCreateIdentityProvider(ctx context.Context) (*shared.CreateIdentityProvider, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PortalIdentityProviderResourceModel) ToSharedUpdateIdentityProvider(ctx context.Context) (*shared.UpdateIdentityProvider, diag.Diagnostics) {
	var diags diag.Diagnostics
