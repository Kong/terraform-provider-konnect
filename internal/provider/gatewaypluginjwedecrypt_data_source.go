...
var _ datasource.DataSource = &GatewayPluginJweDecryptDataSource{}
var _ datasource.DataSourceWithConfigure = &GatewayPluginJweDecryptDataSource{}

func NewGatewayPluginJweDecryptDataSource() datasource.DataSource {
	return &GatewayPluginJweDecryptDataSource{}
}

// GatewayPluginJweDecryptDataSource is the data source implementation.
type GatewayPluginJweDecryptDataSource struct {
	client *sdk.Konnect
}
...
func (r *GatewayPluginJweDecryptDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_gateway_plugin_jwe_decrypt"
}

// Schema defines the schema for the data source.
func (r *GatewayPluginJweDecryptDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "GatewayPluginJweDecrypt DataSource",
...
func (r *GatewayPluginJweDecryptDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *GatewayPluginJweDecryptDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *GatewayPluginJweDecryptDataSourceModel
