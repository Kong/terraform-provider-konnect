...
func (r *MeshHTTPRouteResourceModel) ToSharedMeshHTTPRouteItem() *shared.MeshHTTPRouteItem {
	...
	if r.Spec.TargetRef != nil {
		kind := new(shared.MeshHTTPRouteItemKind)
	...
	for _, toItem := range r.Spec.To {
		...
		for _, rulesItem := range toItem.Rules {
			...
			for _, backendRefsItem := range rulesItem.Default.BackendRefs {
				kind1 := new(shared.MeshHTTPRouteItemSpecToKind)
			...
			for _, filtersItem := range rulesItem.Default.Filters {
				...
				if filtersItem.RequestMirror != nil {
					kind2 := new(shared.MeshHTTPRouteItemSpecToRulesKind)
					if !filtersItem.RequestMirror.BackendRef.Kind.IsUnknown() && !filtersItem.RequestMirror.BackendRef.Kind.IsNull() {
		...
		var targetRef1 *shared.MeshHTTPRouteItemSpecTargetRef
		if toItem.TargetRef != nil {
			kind3 := new(shared.MeshHTTPRouteItemSpecKind)
		...
		for toCount, toItem := range resp.Spec.To {
			...
			for rulesCount, rulesItem := range toItem.Rules {
				...
				for backendRefsCount, backendRefsItem := range rulesItem.Default.BackendRefs {
					...
					backendRefs1.ProxyTypes = []types.String{}
				...
				for filtersCount, filtersItem := range rulesItem.Default.Filters {
					...
					if filtersItem.RequestHeaderModifier == nil {
						...
						filters1.RequestHeaderModifier.Remove = []types.String{}
					...
					if filtersItem.RequestMirror == nil {
						...
						filters1.RequestMirror.BackendRef.ProxyTypes = []types.String{}
					...
					if filtersItem.ResponseHeaderModifier == nil {
						...
						filters1.ResponseHeaderModifier.Remove = []types.String{}
			...
			if toItem.TargetRef == nil {
				...
				to1.TargetRef = &tfTypes.MeshAccessLogItemTargetRef{}
