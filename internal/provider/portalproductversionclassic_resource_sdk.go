...
func (r *PortalProductVersionClassicResourceModel) RefreshFromSharedV2PortalProductVersion(ctx context.Context, resp *shared.V2PortalProductVersion) diag.Diagnostics {
...
func (r *PortalProductVersionClassicResourceModel) ToOperationsDeletePortalProductVersionClassicRequest(ctx context.Context) (*operations.DeletePortalProductVersionClassicRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	out := operations.DeletePortalProductVersionClassicRequest{
...
func (r *PortalProductVersionClassicResourceModel) ToOperationsGetPortalProductVersionClassicRequest(ctx context.Context) (*operations.GetPortalProductVersionClassicRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	out := operations.GetPortalProductVersionClassicRequest{
		ProductVersionID: productVersionID,
		PortalID:         portalID,
	}
...
func (r *PortalProductVersionClassicResourceModel) ToOperationsReplacePortalProductVersionClassicRequest(ctx context.Context) (*operations.ReplacePortalProductVersionClassicRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	out := operations.ReplacePortalProductVersionClassicRequest{
		ProductVersionID:                     productVersionID,
		PortalID:                             portalID,
...
func (r *PortalProductVersionClassicResourceModel) ToSharedV2ReplacePortalProductVersionPayload(ctx context.Context) (*shared.V2ReplacePortalProductVersionPayload, diag.Diagnostics) {
	var diags diag.Diagnostics
