...
func (r *GatewayPluginMockingResourceModel) ToSharedCreateMockingPlugin() *shared.CreateMockingPlugin {
	...
	var ordering *shared.CreateMockingPluginOrdering
	if r.Ordering != nil {
		var after *shared.CreateMockingPluginAfter
		if r.Ordering.After != nil {
			var access []string = []string{}
			for _, accessItem := range r.Ordering.After.Access {
				access = append(access, accessItem.ValueString())
			}
			after = &shared.CreateMockingPluginAfter{
				Access: access,
			}
		}
		var before *shared.CreateMockingPluginBefore
		if r.Ordering.Before != nil {
			var access1 []string = []string{}
			for _, accessItem1 := range r.Ordering.Before.Access {
				access1 = append(access1, accessItem1.ValueString())
			}
			before = &shared.CreateMockingPluginBefore{
				Access: access1,
			}
		}
		ordering = &shared.CreateMockingPluginOrdering{
			After:  after,
			Before: before,
		}
	}
