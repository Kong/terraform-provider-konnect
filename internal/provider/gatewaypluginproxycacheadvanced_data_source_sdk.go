...
func (r *GatewayPluginProxyCacheAdvancedDataSourceModel) ToOperationsGetProxycacheadvancedPluginRequest(ctx context.Context) (*operations.GetProxycacheadvancedPluginRequest, diag.Diagnostics) {
...
func (r *GatewayPluginProxyCacheAdvancedDataSourceModel) RefreshFromSharedProxyCacheAdvancedPlugin(ctx context.Context, resp *shared.ProxyCacheAdvancedPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
