...
func (r *GatewayPluginUpstreamOauthResourceModel) ToSharedUpstreamOauthPluginInput() *shared.UpstreamOauthPluginInput {
	enabled := new(bool)
	...
	out := shared.UpstreamOauthPluginInput{
		Enabled:       enabled,
		ID:            id,
...
func (r *GatewayPluginUpstreamOauthResourceModel) RefreshFromSharedUpstreamOauthPlugin(resp *shared.UpstreamOauthPlugin) {
	if resp != nil {
		...
		if resp.Ordering != nil {
			...
			for key2, value2 := range resp.Ordering {
				r.Ordering[key2] = types.StringValue(value2)
			}
		}
