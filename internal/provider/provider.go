...
func (p *KonnectProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewCmekResource,
		NewCatalogAiModelResource,
		NewCatalogAiModelImplementationResource,
		NewCatalogAiModelVersionResource,
		NewCatalogAiModelVersionSpecResource,
		NewCatalogMCPResource,
		NewCatalogMCPImplementationResource,
		NewCatalogMCPVersionResource,
		...
		NewGatewayClonedPluginResource,
