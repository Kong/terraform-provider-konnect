...
func (p *KonnectProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewEventGatewayListenerPolicyChainResource,
		...
		NewEventGatewayVirtualClusterClusterPolicyChainResource,
		NewEventGatewayVirtualClusterConsumePolicyChainResource,
		NewEventGatewayVirtualClusterProducePolicyChainResource,
