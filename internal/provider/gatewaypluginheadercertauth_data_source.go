...
var _ datasource.DataSource = &GatewayPluginHeaderCertAuthDataSource{}
var _ datasource.DataSourceWithConfigure = &GatewayPluginHeaderCertAuthDataSource{}

func NewGatewayPluginHeaderCertAuthDataSource() datasource.DataSource {
	return &GatewayPluginHeaderCertAuthDataSource{}
}

// GatewayPluginHeaderCertAuthDataSource is the data source implementation.
type GatewayPluginHeaderCertAuthDataSource struct {
	client *sdk.Konnect
}

// GatewayPluginHeaderCertAuthDataSourceModel describes the data model.
type GatewayPluginHeaderCertAuthDataSourceModel struct {
...
func (r *GatewayPluginHeaderCertAuthDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_gateway_plugin_header_cert_auth"
}

// Schema defines the schema for the data source.
func (r *GatewayPluginHeaderCertAuthDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "GatewayPluginHeaderCertAuth DataSource",
...
func (r *GatewayPluginHeaderCertAuthDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *GatewayPluginHeaderCertAuthDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *GatewayPluginHeaderCertAuthDataSourceModel
